...
window.addEventListener('DOMContentLoaded', function() { jQuery(document).ready(function() { var selector = "#\_header-26-11", scrollval = parseInt("52"); if (!scrollval || scrollval \< 1) { jQuery("body").css("margin-top", jQuery(selector).outerHeight()); jQuery(selector).addClass("oxy-sticky-header-active"); } else { var scrollTopOld = 0; jQuery(window).scroll(function() { if (!jQuery('body').hasClass('oxy-nav-menu-prevent-overflow')) { if (jQuery(this).scrollTop() \> scrollval ) { if ( !jQuery(selector).hasClass("oxy-sticky-header-active")) { if (jQuery(selector).css('position')!='absolute') { jQuery("body").css("margin-top", jQuery(selector).outerHeight()); } jQuery(selector) .addClass("oxy-sticky-header-active") } } else { jQuery(selector) .removeClass("oxy-sticky-header-fade-in") .removeClass("oxy-sticky-header-active"); if (jQuery(selector).css('position')!='absolute') { jQuery("body").css("margin-top", ""); } } scrollTopOld = jQuery(this).scrollTop(); } }) } }); });
 ...
 function togglePushDataLayer(elementId, eventValue) { var h2Element = document.getElementById(elementId); var button = h2Element.querySelector('.accordion-button'); if(button.classList.contains('collapsed')) { PushDataLayer('cancer\_btn', 'cancer\_insurance', 'close', 'things\_to\_know', eventValue); } else { PushDataLayer('cancer\_btn', 'cancer\_insurance', 'view', 'things\_to\_know', eventValue); }
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-101-4208" alt="" src="/th/wp-content/uploads/2024/07/Big\_Cancer\_cell\_OntopPage.png" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-102-4208" alt="" src="/th/wp-content/uploads/2024/07/Small\_Cancer\_cell\_OntopPage.png" class="ct-image"/\>
...
และมีอัตราสูงขึ้นเรื่อยๆ ในทุกเพศทุกวัย

แต่สามารถรักษาและหายได้ถ้ารู้เร็ว

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-20-4208" alt="" src="/th/wp-content/uploads/2024/07/Cover\_CA\_OntopPage\_.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-95-4208" alt="" src="/th/wp-content/uploads/2024/07/Combined-\_Shape\_Cancer\_Section\_2.png" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-97-4208" alt="" src="/th/wp-content/uploads/2024/07/Combined-\_Shape\_Cancer\_Section\_2\_mobile.png" class="ct-image"/\>

ทำประกันมะเร็งดีอย่างไร
----------

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-77-4208" alt="" src="/th/wp-content/uploads/2024/07/Ribbin\_cancer\_section\_2\_.png" class="ct-image"/\>

จ่ายหลักพัน คุ้มครองหลักล้าน

ให้คุณสบายใจทั้งค่าใช้จ่ายและการรักษา

ไม่ต้องกังวลเรื่อง  
ค่าใช้จ่าย รักษาได้เต็มที่  
เพิ่มโอกาสหายมากขึ้น

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-85-4208" alt="" src="/th/wp-content/uploads/2024/07/Icon\_cancer\_section\_2\_1.png" class="ct-image"/\>

ช่วยลดภาระค่าใช้จ่าย  
ไม่ต้องใช้เงินเก็บ ขณะรักษาตัว

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-94-4208" alt="" src="/th/wp-content/uploads/2024/07/Icon\_cancer\_section\_2\_2.png" class="ct-image"/\>

มีทุนสำรองให้กับ  
ครอบครัว กรณีเสียชีวิตจากโรคมะเร็ง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-91-4208" alt="" src="/th/wp-content/uploads/2024/07/Icon\_cancer\_section\_2\_3.png" class="ct-image"/\>

เบี้ยประกันช่วย  
ลดหย่อนภาษีได้ สูงสุด 25,000 บาทต่อปี

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-88-4208" alt="" src="/th/wp-content/uploads/2024/07/Icon\_cancer\_section\_2\_4.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-364-4208" alt="" src="/th/wp-content/uploads/2024/07/Ribbin\_cancer\_section\_3\_right\_bottom.png" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-363-4208" alt="" src="/th/wp-content/uploads/2024/07/Ribbin\_cancer\_section\_3\_right\_top.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-128-4208" alt="" src="/th/wp-content/uploads/2024/07/Combined-\_Shape\_Cancer\_Section\_3.png" class="ct-image"/\>

#### จ่ายตั้งแต่ระยะแรกดูแลถึงระยะลุกลาม ####

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-117-4208" alt="" src="/th/wp-content/uploads/2024/07/prudential\_logo\_for\_cancer\_section\_3\_edit.png" class="ct-image"/\>

รับประกันโดย พรูเด็นเชียล ประกันชีวิต

สำหรับอายุ 20-64 ปี

ตอบคำถามสุขภาพแค่ 4 ข้อ

ตรวจเจอ รับเงินก้อน ยังคุ้มครองต่อ

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-136-4208" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

คุ้มครองสูงสุด 1.5 ล้าน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-143-4208" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

ตรวจเจอระยะไม่ลุกลาม รับก้อนแรก

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-146-4208" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

รักษาต่อจนถึงระยะลุกลาม ยังได้อีกก้อน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-149-4208" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

จ่ายเบี้ยเริ่มต้นหลักร้อย คุ้มครองสูงสุดหลักล้าน

ดูรายละเอียด

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1259-4208" alt="" src="/th/wp-content/uploads/2024/07/first\_section\_coupon\_promotion\_copy\_cancer.png" class="ct-image"/\>

ลด 10%

ใส่โค้ด “HEY10”

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1269-4208" alt="" src="/th/wp-content/uploads/2024/07/copy\_icon\_for\_cancer\_page.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-171-4208" alt="" src="/th/wp-content/uploads/2024/07/Combined-\_Shape\_Cancer\_Section\_3.png" class="ct-image"/\>

#### คุ้มครองทุกระยะ รับ 2 เท่า 5 มะเร็งพบบ่อย ####

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-175-4208" alt="" src="/th/wp-content/uploads/2024/07/mueng\_thai\_logo\_for\_cancer\_section\_3\_edit.png" class="ct-image"/\>

รับประกันโดย เมืองไทยประกันภัย

สำหรับอายุ 14 วัน-60 ปี

ตอบคำถามสุขภาพแค่ 5 ข้อ

ตรวจเจอ รับเงินก้อน จบความคุ้มครอง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-185-4208" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

รับเงินก้อนสูงสุด 2.2 ล้าน เมื่อตรวจพบทุกระยะ

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-188-4208" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

รับ 2 เท่า สำหรับ 5 มะเร็งที่พบบ่อย (ปากมดลูก, เต้านม, ตับ, ปอด, ต่อมลูกหมาก)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-194-4208" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>
...
](https://mtiecommerce.muangthaiinsurance.com/product/Portal/?enckey=5VczkoFb)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1778-5333" alt="" src="/th/wp-content/uploads/2024/07/fire\_logo\_for\_cancer\_section\_3.png" class="ct-image"/\>

รับเพิ่ม Central VC ถึง 30 ธ.ค.67 

[

 คลิก

](/th/promotion/healthinsurance/caci-mtl-central-aug2024/)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-219-4208" alt="" src="/th/wp-content/uploads/2024/07/Combined-\_Shape\_Cancer\_Section\_3.png" class="ct-image"/\>

#### คุ้มครองมะเร็งทุกระยะ และ ไตวายเรื้อรัง เบิกค่ารักษาตามจริง สูงสุด 10 ล้าน เข้าได้ทุก รพ. ####

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-223-4208" alt="" src="/th/wp-content/uploads/2024/07/mueng\_thai\_life\_logo\_for\_cancer\_section\_3\_edit.png" class="ct-image"/\>

รับประกันโดย เมืองไทยประกันชีวิต

สำหรับอายุ 20-70 ปี

ตอบคำถามสุขภาพแค่ 3 ข้อ

เบิกค่ารักษาได้ตามค่าใช้จ่ายจริงได้ทุก รพ.

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-233-4208" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

เบิกค่ารักษาได้ตามค่าใช้จ่ายจริงได้ทุก รพ.

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-236-4208" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

บำบัดโรคทางจิตเวชหลังป่วย

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-239-4208" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

ต่ออายุได้สูงสุดถึงอายุ 99 ปี

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-


![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1543-4208" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

ฟรี โปรแกรมตรวจสุขภาพเมื่อต่ออายุ

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1609-4208" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

การันตีต่ออายุได้ถึง 80 ปี

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1545-4208" alt="" src="/th/wp-content/uploads/2024/07/Combined\_Shape\_smile\_popup\_modal\_cancer.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1563-4208" alt="" src="/th/wp-content/uploads/2024/07/viriyah\_logo\_for\_cancer\_section\_3.png" class="ct-image"/\>
...
* ค่าธรรมเนียมแพทย์ผ่าตัด สำหรับแพทย์ หรือคณะแพทย์ ผู้ช่วยศัลยแพทย์ หรือแพทย์ที่ทำการผ่าตัดหรือหัตถการทางการแพทย์
* ค่าธรรมเนียมแพทย์ วิสัญญี / พยาบาล วิสัญญี ค่าแพทย์เยี่ยมไข้ หรือค่าปรึกษาแพทย์ผู้เชี่ยวชาญเฉพาะโรค
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1723-4208" alt="" src="https://pre.heygoody.com/th/wp-content/uploads/2024/07/hand-slide\_for\_cancer.gif" class="ct-image"/\>

เลื่อนดูเพิ่มเติม

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1273-4208" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_copy\_success\_popup\_cancer\_page.png" class="ct-image"/\>

คัดลอกแล้ว

สิ่งที่ควรรู้ เมื่อซื้อประกันโรคมะเร็ง
----------

#### เงื่อนไขการซื้อประกันโรคมะเร็ง  ####

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/07/prudential\_logo\_for\_cancer\_section\_3\_edit.png" style="width: 40px;height: 40px;margin-right: 12px;"\>พรูเด็นเชียล ประกันชีวิต

* ระยะเวลาคุ้มครองและระยะเวลาชำระเบี้ยฯ แบบปีต่อปี
* รับประกันภัยบุคคลสัญชาติไทยที่อาศัยอยู่ในประเทศไทย
* ผู้เอาประกันภัยสามารถทำประกันภัยได้คนละ 1 ฉบับ
* เบี้ยประกันภัยขึ้นอยู่กับเพศและอายุ เบี้ยประกันภัยปีต่ออาจปรับเพิ่มได้
* ระยะเวลาที่ไม่คุ้มครอง (waiting period)สำหรับการป่วยด้วยโรคร้ายแรงที่เกิดขึ้นภายใน 90 วัน นับตั้งแต่วันที่สัญญาเพิ่มเติมเริ่มมีผลคุ้มครอง
* ไม่คุ้มครองโรคหรือความผิดปกติที่เกี่ยวข้องกับโรคร้ายแรงที่เป็นมาก่อนการรับประกัน (Pre-Existing Condition)
* ผู้เอาประกันภัยจะต้องมีสุขภาพร่างกายแข็งแรงสมบูรณ์ ณ วันที่ขอทำประกันภัย
* การพิจารณารับประกันภัยไม่ต้องตรวจสุขภาพ เพียงตอบคำถามสุขภาพ

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/07/viriyah\_logo\_for\_cancer\_section\_3.png" style="width: 40px;height: 40px;margin-right: 12px;"\>วิริยะประกันภัย

* รับประกันภัยเฉพาะคนไทย ที่มีสัญชาติไทยเท่านั้น
* รับประกันภัยด้วยการตอบคำถามสุขภาพ โดยไม่ต้องตรวจสุขภาพ
* ระยะรอคอย 90 วัน
* เบี้ยประกันภัยจะปรับเพิ่มขึ้นตามช่วงอายุ
* รับประกันการต่ออายุเมื่อครบรอบปีกรมธรรม์ (Guarantee Renewal)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/07/mueng\_thai\_logo\_for\_cancer\_section\_3\_edit.png" style="width: 40px;height: 40px;margin-right: 12px;"\>เมืองไทยประกันภัย

* รับประกันภัยเฉพาะคนไทย ที่มีสัญชาติไทยเท่านั้น
* รับประกันภัยด้วยการตอบคำถามสุขภาพ โดยไม่ต้องตรวจสุขภาพ
* ระยะรอคอย 90 วัน
* เบี้ยประกันภัยจะปรับเพิ่มขึ้นตามช่วงอายุ
* ผลประโยชน์ความคุ้มครองโรคมะเร็งของทุกกรมธรรม์ภายใต้บริษัท เมืองไทยประกันภัย รวมกัน ไม่เกิน 1 ล้านบาทต่อคน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/07/mueng\_thai\_life\_logo\_for\_cancer\_section\_3\_edit.png" style="width: 40px;height: 40px;margin-right: 12px;"\>เมืองไทยประกันชีวิต

* โครงการเมืองไทย Care Plus เป็นชื่อทางการตลาดของแบบประกันภัย เมืองไทย สมาร์ท โพรเทคชั่น 99/99 และสัญญาเพิ่มเติม แคร์ พลัส
* รับประกันเฉพาะคนไทยที่มีสัญชาติไทยเท่านั้น
* สัญญาเพิ่มเติม แคร์ พลัส พื้นที่ความคุ้มครองเฉพาะประเทศไทย
* รับประกันภัยด้วยการตอบคำถามสุขภาพ โดยไม่ต้องตรวจสุขภาพ
* ระยะรอคอย 90 วัน
* เบี้ยประกันภัยจะเปลี่ยนแปลงตามอายุของผู้เอาประกันภัย
* บริษัทจะจ่ายค่ารักษาพยาบาล OPD+IPD โรคมะเร็งและ/หรือไตวายเรื้อรัง หรือค่าบริการทางการแพทย์เพื่อการบำบัดรักษาโรคมะเร็งและ/หรือโรคไตวายเรื้อรัง สำหรับวิธีการบำบัดรักษาตามที่บริษัทฯ กำหนด ทั้งนี้ขึ้นอยู่กับแผนความคุ้มครองที่เลือกซื้อ
* ความคุ้มครองโรคทางจิตเวช คุ้มครองไม่เกิน 1% ของผลประโยชน์สูงสุดต่อรอบปีกรมธรรม์ของสัญญาเพิ่มเติม แคร์ พลัส และคุ้มครองภายใน 5 ปี นับแต่ปีกรมธรรม์ที่ผู้เอาประกันภัยเริ่มได้รับการรักษาโรคมะเร็ง และ/หรือ ไตวายเรื้อรัง โดยวงเงินแยกกันตามแต่ละโรค
...
#### เงื่อนไขการจ่ายค่าสินไหม  ####

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/07/prudential\_logo\_for\_cancer\_section\_3\_edit.png" style="width: 40px;height: 40px;margin-right: 12px;"\>พรูเด็นเชียล ประกันชีวิต

ชดเชยสินไหมแบบเงินก้อน เมื่อตรวจพบโรคมะเร็ง ในกรณีที่มะเร็งนั้นอยู่ในระยะไม่ลุกลาม กรมธรรม์จะยังให้ความคุ้มครองต่อเนื่อง และจะชดเชยสินไหมแบบเงินก้อนให้อีกครั้ง หากตรวจพบมะเร็งระยะลุกลาม

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/07/viriyah\_logo\_for\_cancer\_section\_3.png" style="width: 40px;height: 40px;margin-right: 12px;"\>วิริยะประกันภัย

ชดเชยสินไหมแบบค่ารักษาตามจริง โดยจะต้องมีการเข้ารับการรักษาในโรงพยาบาลเครือ BDMS เท่านั้น

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/07/mueng\_thai\_logo\_for\_cancer\_section\_3\_edit.png" style="width: 40px;height: 40px;margin-right: 12px;"\>เมืองไทยประกันภัย

ชดเชยสินไหมแบบเงินก้อน เมื่อตรวจพบโรคมะเร็งเป็นครั้งแรก โดยมะเร็งนั้นจะอยู่ในระยะลุกลาม หรือไม่ลุกลามก็ได้ และความคุ้มครองจะสิ้นสุดทันที

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/07/mueng\_thai\_life\_logo\_for\_cancer\_section\_3\_edit.png" style="width: 40px;height: 40px;margin-right: 12px;"\>เมืองไทยประกันชีวิต

ชดเชยสินไหมแบบค่ารักษาตามวงเงินและความคุ้มครองที่เลือกซื้อโดยจะต้องมีการเข้ารับการรักษาในโรงพยาบาลเท่านั้น

#### ติดต่อบริษัทประกัน  ####

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/07/prudential\_logo\_for\_cancer\_section\_3\_edit.png" style="width: 40px;height: 40px;"\>

พรูเด็นเชียล ประกันชีวิต

โทร: [1621](tel:1621)

 Email: [[email protected]](mail:hotline@prudential.co.th)  
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/07/viriyah\_logo\_for\_cancer\_section\_3.png" style="width: 40px;height: 40px;"\>

วิริยะประกันภัย

โทร: [02-422-8888](tel:024228888)

 Line: [@viriyah.com](https://line.me/R/ti/p/@viriyah.com)  
 ตลอด 24 ชั่วโมง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/07/mueng\_thai\_logo\_for\_cancer\_section\_3\_edit.png" style="width: 40px;height: 40px;"\>

เมืองไทยประกันภัย

โทร: [1484](tel:1484)

 Email: [[email protected]](mail:info@muangthaiinsurance.com)  
 ตลอด 24 ชั่วโมง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/07/mueng\_thai\_life\_logo\_for\_cancer\_section\_3\_edit.png" style="width: 40px;height: 40px;"\>
...
[นโยบายความเป็นส่วนตัว](/privacypolicy) | [นโยบายส่วนบุคคลเกี่ยวกับคุกกี้](/cookiepolicy)
 ...
 (function(h,o,t,j,a,r){ h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)}; h.\_hjSettings={hjid:3132820,hjsv:6}; a=o.getElementsByTagName('head')[0]; r=o.createElement('script');r.async=1; r.src=t+h.\_hjSettings.hjid+j+h.\_hjSettings.hjsv; a.appendChild(r); })(window,document,'https://static.hotjar.com/c/hotjar-','.js?sv=');window.addEventListener('DOMContentLoaded', function() {function OnclickFadeOut() { jQuery("#hand-slide").fadeOut();
}});window.addEventListener('DOMContentLoaded', function() {function OnclickFadeOut() { jQuery("#hand-slide").fadeOut();
}});window.addEventListener('DOMContentLoaded', function() {function OnclickFadeOut() { jQuery("#hand-slide").fadeOut();
}});window.addEventListener('DOMContentLoaded', function() {function OnclickFadeOut() { jQuery("#hand-slide").fadeOut();
...
var div2 = document.getElementById('div\_block-1133-4208');
window.onload = function() { div1.addEventListener('scroll', function() { div2.scrollLeft = div1.scrollLeft; }); div2.addEventListener('scroll', function() { div1.scrollLeft = div2.scrollLeft; }); $(".scrollleft\_").on('scroll', function() { if ($(this).scrollLeft() \> 0) { $("#div\_block-1711-4208").fadeOut(); } }); $(".scrollleft\_1").on('scroll', function() { if ($(this).scrollLeft() \> 0) { $("#div\_block-1716-4208").fadeOut(); } }); $(".scrollleft\_2").on('scroll', function() { if ($(this).scrollLeft() \> 0) { $("#div\_block-1719-4208").fadeOut(); } }); $(".scrollleft\_3").on('scroll', function() { if ($(this).scrollLeft() \> 0) { $("#div\_block-1722-4208").fadeOut(); } }); } window.onscroll = function() { myFunction(); if(window.scrollY \<= 750){ $("#div\_block-2153-2305").fadeOut(); $("#onetrust-consent-sdk").removeClass("show"); }else{ $("#div\_block-2153-2305").fadeIn(); $("#onetrust-consent-sdk").addClass("show"); }
}; var header = document.getElementById("code\_block-587-11");
var targetElement = document.getElementById("div\_block-456-4208");
var targetElement2 = document.getElementById("div\_block-481-4208");
var targetElement3 = document.getElementById("section-610-4208"); function myFunction() { if (!header || !targetElement) { return; } var headerRect = header.getBoundingClientRect(); var targetRect = targetElement.getBoundingClientRect(); var targetRect2 = targetElement2.getBoundingClientRect(); var targetRect3 = targetElement3.getBoundingClientRect(); //console.log(targetRect2.top);
if (headerRect.bottom \>= targetRect.top) { if ($(window).width() \<= 768) { $("#div\_block-1100-4208").css({ "top": "52px" }); div2.scrollLeft = div1.scrollLeft; div1.scrollLeft = div2.scrollLeft; $("#div\_block-396-4208").css('opacity', '0'); $("#div\_block-418-4208").css('opacity', '0'); $("#div\_block-445-4208").css('opacity', '0'); $("#div\_block-439-4208").css('opacity', '0'); $("#div\_block-433-4208").css('opacity', '0'); } } if(headerRect.bottom \>= targetRect3.top) { $("#div\_block-1100-4208").css({ "top": "-100%" }); } if (targetRect2.top \> 210) { if ($(window).width() \<= 768) { //console.log("do"); $("#div\_block-1100-4208").css({ "top": "-100%" }); $("#div\_block-396-4208").css('opacity', '1'); $("#div\_block-418-4208").css('opacity', '1'); $("#div\_block-445-4208").css('opacity', '1'); $("#div\_block-439-4208").css('opacity', '1'); $("#div\_block-433-4208").css('opacity', '1'); } } } function copyTextToClipboard(text) { // Create a temporary hidden textarea element to hold the text const textArea = document.createElement("textarea"); textArea.value = text; textArea.style.position = "fixed"; // Avoid scrolling to bottom textArea.style.left = "-9999px"; // Move element out of the screen document.body.appendChild(textArea); textArea.focus(); textArea.select(); try { // Use the Clipboard API to copy the text document.execCommand('copy'); var copysuccess = document.getElementById("div\_block-1272-4208"); console.log('Text successfully copied'); copysuccess.style.display = "flex"; setTimeout( function() { copysuccess.style.display = "none"; }, 1200 ); } catch (err) { console.error('Unable to copy text', err); } // Remove the temporary element document.body.removeChild(textArea);
} // Example usage:
document.querySelector("#copyButton").addEventListener("click", function() { const text = document.querySelector("#textToCopy").innerText; copyTextToClipboard(text);
}); });@media screen and (max-width: 1199px) { #div\_block-405-4208,#div\_block-1133-4208,#div\_block-1064-4208,#div\_block-1336-4208 { overflow-x: auto; }
} @media only screen and (min-width: 1200px) { #section-365-4208 \> .ct-section-inner-wrap { max-width: 1200px !important; }
}
.text-point-split { content: ''; width: 8px; rotate: 180deg; height: 100%; position: absolute; top: 0; left: 0; border-width: 0px 0px 24px 9px; border-color: transparent transparent #fff transparent; border-style: solid;
}
.modal-header { height: auto; min-height: auto;
} @media screen and (max-width: 767px) { #div\_block-1064-4208,#div\_block-1572-4208 { overflow-x: auto; overscroll-behavior: none; }
} #div\_block-1064-4208::-webkit-scrollbar,#div\_block-405-4208::-webkit-scrollbar,#div\_block-1133-4208::-webkit-scrollbar,#div\_block-1572-4208::-webkit-scrollbar,#div\_block-1336-4208::-webkit-scrollbar { display: none; /\* This hides the scrollbar \*/
}
#div\_block-1100-4208 { transition: all .6s ease-in-out;
} .logo\_bdms { width: 56px;
}
.sp\_ { color: var(--text-caption-on-light, #5C5C5C); font-size: 16px; font-style: normal; font-weight: 400; line-height: normal;
}
.h\_d\_viriyah { color: var(--text-title-on-light, #1D1D1D); font-size: 22px; font-style: normal; font-weight: 700; line-height: 32px;
} @media screen and (max-width: 992px) { .h\_d\_viriyah { font-size: 20px; line-height: 28px; } .logo\_bdms { width: 38px; }
...
a.gobackRenewal.fn-btn-goBack.fn-cursor-pointer { display: none;
}
.ct-section { overflow-x: unset !important;
} #section-73-4208 \> .ct-section-inner-wrap { align-items: center;
...
.accordion-item h4 button { font-size: 18px; font-family: NotoSansThai; line-height: normal; margin: 0; font-weight: bold;
