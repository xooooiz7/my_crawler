...
function TooltipOpen(param) { $(".tooltip\_alert").fadeOut(); // Fade out all tooltips $(".tooltip\_" + param).fadeIn(); // Only fade in the relevant tooltip
} // This function sets up the event listeners to check for clicks outside tooltip buttons
$(document).ready(function() { // Handles both mouse and touch events $(document).on('mousedown touchstart', function(event) { var target = $(event.target); // Get the clicked/touched element if (!target.closest('.tooltip-btn').length) { // If the touch/click was not within a tooltip button $(".tooltip\_alert").fadeOut(); // Fade out all tooltips } });
}); document.addEventListener("DOMContentLoaded", function() { // Function to get the value of a query parameter by name function getQueryParam(name) { const urlParams = new URLSearchParams(window.location.search); return urlParams.get(name); } // Retrieve the 'section' parameter from the URL const section = getQueryParam('section'); // Check if 'section' parameter is 'plan' if (section === 'plan') { // Get the element by ID const element = document.getElementById('div\_block-139-4303'); // Scroll to the element smoothly element.scrollIntoView({ behavior: 'smooth' }); }
});
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-80-4303" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/09/Cover\_For\_CI\_Page.webp" class="ct-image" fetchpriority="high"/\>

\*เงื่อนไขเป็นไปตามแผนความคุ้มครองที่ระบุในกรมธรรม์

ทำไมต้องทำประกันโรคร้ายแรง
----------

เตรียมพร้อมไว้ก่อน ใช้ชีวิตแบบไม่มีสะดุด ด้วยความคุ้มครองแบบเงินก้อน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-95-4303" alt="" src="/th/wp-content/uploads/2024/07/Icon\_cancer\_section\_2\_1.png" class="ct-image"/\>

หมดห่วงเรื่องค่ารักษา

มีเงินจ่าย เพื่อให้ได้รับการรักษาที่ดีที่สุด

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-120-4303" alt="" src="/th/wp-content/uploads/2024/07/Icon\_cancer\_section\_2\_2.png" class="ct-image"/\>

มีเงินใช้ระหว่างรักษาตัว

แม้ทำงานไม่ได้ ก็ยังมีเงินสำรองไว้ใช้จ่าย

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-125-4303" alt="" src="/th/wp-content/uploads/2024/07/Icon\_cancer\_section\_2\_3.png" class="ct-image"/\>

ลดภาระให้คนที่คุณรัก

แม้เจ็บป่วย ก็มีเงินก้อนไว้ให้คนที่คุณห่วงใย

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-130-4303" alt="" src="/th/wp-content/uploads/2024/07/Icon\_cancer\_section\_2\_4.png" class="ct-image"/\>

ได้ผลประโยชน์ทางภาษี

ลดหย่อนภาษีได้สูงสุด 25,000 บาท/ปี

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-134-4303" alt="" src="/th/wp-content/uploads/2024/07/Combined\_Shape\_Left\_Section\_2\_for\_CI.png" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-135-4303" alt="" src="/th/wp-content/uploads/2024/07/Combined\_Shape\_Right\_Section\_2\_for\_CI.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-143-4303" alt="" src="/th/wp-content/uploads/2024/07/fire\_logo\_for\_cancer\_section\_3.png" class="ct-image"/\>

ฟรี Starbucks สูงสุด 200.-

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-146-4303" alt="" src="/th/wp-content/uploads/2024/07/information\_circle\_icon\_cancer\_section\_3.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-148-4303" alt="" src="/th/wp-content/uploads/2024/07/Combined-\_Shape\_Cancer\_Section\_3.png" class="ct-image"/\>

#### จ่ายทันทีเมื่อพบ 4 โรคร้าย ####

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-152-4303" alt="" src="/th/wp-content/uploads/2024/07/prudential\_logo\_for\_cancer\_section\_3\_edit.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-162-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

จ่ายหลักร้อย คุ้มครองหลักล้าน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-165-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

คุ้มครองครบ หัวใจ สโตรค ไตวาย โคม่า

ดูรายละเอียด

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-176-4303" alt="" src="/th/wp-content/uploads/2024/07/first\_section\_coupon\_promotion\_copy\_cancer.png" class="ct-image"/\>

ลด 15%

ใส่โค้ด “heygoody15”

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-181-4303" alt="" src="/th/wp-content/uploads/2024/07/copy\_icon\_for\_cancer\_page.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1176-5325" alt="" src="/th/wp-content/uploads/2024/07/fire\_logo\_for\_cancer\_section\_3.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-226-4303" alt="" src="/th/wp-content/uploads/2024/07/Combined-\_Shape\_Cancer\_Section\_3.png" class="ct-image"/\>

#### โรคร้ายหลบไป เลือกซื้อกลุ่มโรคที่กังวลได้ถึง 6 กลุ่ม ####

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-230-4303" alt="" src="/th/wp-content/uploads/2024/07/mueng\_thai\_life\_logo\_for\_cancer\_section\_3\_edit.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-240-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

เจอ จ่าย สูงสุด 1 ล้านบาท  

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-243-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

เลือกซื้อตามกลุ่มโรคได้ หัวใจ ตับไต สมอง มะเร็ง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-246-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

คุ้มครองจนถึงอายุ 69 ปี
...
](https://online.muangthai.co.th/th/calculate/heygoody/d-care/)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-193-4303" alt="" src="/th/wp-content/uploads/2024/07/Combined-\_Shape\_Cancer\_Section\_3.png" class="ct-image"/\>

#### ครอบคลุมทั้งมะเร็งทุกระยะ  
และโรคร้ายที่พบบ่อย ####

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-197-4303" alt="" src="/th/wp-content/uploads/2024/07/mueng\_thai\_logo\_for\_cancer\_section\_3\_edit.png" class="ct-image"/\>

รับประกันโดย เมืองไทยประกันภัย

สำหรับอายุ 16-60 ปี

ตอบคำถามสุขภาพแค่ 9 ข้อ

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-207-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

รับเงินก้อนสูงสุด 5 แสน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-210-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

คุ้มครองครบทั้งมะเร็ง หัวใจ สมอง ปอด

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-213-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>
...
](https://mtiecommerce.muangthaiinsurance.com/product/Portal/?enckey=8BybA82f)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-312-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_copy\_success\_popup\_cancer\_page.png" class="ct-image"/\>
...
เพื่อให้คุณสามารถซื้อประกันโรคร้ายแรง และวางแผนได้ตามใจคุณ
...
](/document/policy-wording/criticalillness/)

มีแผนโรคร้ายที่คุ้มครองมะเร็ง  

คุ้มครองสูงสุด 1 ล้าน

จำนวนโรคที่คุ้มครอง

รับเงินก้อนแบ่งตามระยะของโรค  

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-349-4303" alt="" src="/th/wp-content/uploads/2024/07/prudential\_logo\_for\_cancer\_section\_3\_edit.png" class="ct-image"/\>[

ซื้อเลย

](http://)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-355-4303" alt="" src="/th/wp-content/uploads/2024/07/close\_small\_list\_cancer\_section\_4.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-358-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

แผน 3

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-362-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

4 โรคร้าย 

(ทุกแผน)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-370-4303" alt="" src="/th/wp-content/uploads/2024/07/information-circle\_for\_CI\_Page.png" class="ct-image"/\>

**พรูเด็นเชียล ประกันชีวิต  
คุ้มครอง 4 โรคร้าย** (ทุกแผน)
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-373-4303" alt="" src="/th/wp-content/uploads/2024/07/close\_small\_list\_cancer\_section\_4.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-378-4303" alt="" src="/th/wp-content/uploads/2024/07/mueng\_thai\_life\_logo\_for\_cancer\_section\_3\_edit.png" class="ct-image"/\>[

ซื้อเลย

](https://online.muangthai.co.th/th/calculate/heygoody/d-care/)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-383-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

ทุกระยะ

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-386-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

ทุกแผน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-390-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

6 กลุ่มโรคร้าย

 (ตามแผนที่เลือก)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-395-4303" alt="" src="/th/wp-content/uploads/2024/07/information-circle\_for\_CI\_Page.png" class="ct-image"/\>

**เมืองไทยประกันชีวิต  
คุ้มครอง 6 กลุ่มโรคร้าย** (ตามแผนที่เลือกซื้อ)

1. กลุ่มโรคมะเร็ง
2. กลุ่มโรคหลอดเลือด หัวใจ
3. กลุ่มโรคเปลี่ยนอวัยวะ ตับ ไต ปอด
4. กลุ่มโรคระบบประสาท กล้ามเนื้อ
5. กลุ่มโรคอื่นๆ เช่น สูญเสียอวัยวะ แผลไหม้
6. กลุ่มโรคยอดฮิต มะเร็ง หัวใจ สมอง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-430-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

ระยะเริ่มต้น และระยะรุนแรง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-401-4303" alt="" src="/th/wp-content/uploads/2024/07/mueng\_thai\_logo\_for\_cancer\_section\_3\_edit.png" class="ct-image"/\>[

ซื้อเลย

](https://mtiecommerce.muangthaiinsurance.com/product/Portal/?enckey=8BybA82f)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-425-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

ทุกระยะ

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-409-4303" alt="" src="/th/wp-content/uploads/2024/07/close\_small\_list\_cancer\_section\_4.png" class="ct-image"/\>

สูงสุด 5 แสน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-413-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

4 โรคร้าย 

(ทุกแผน)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-418-4303" alt="" src="/th/wp-content/uploads/2024/07/information-circle\_for\_CI\_Page.png" class="ct-image"/\>

**เมืองไทยประกันภัย  
คุ้มครอง 4 โรคร้าย** (ทุกแผน)

1. มะเร็งทุกระยะ (ไม่รวมมะเร็งผิวหนัง ยกเว้น ประเภท "เมลลาโนมา")
2. กล้ามเนื้อหัวใจตายเฉียบพลัน
3. หลอดเลือดสมองแตกหรืออุดตัน
4. ปอดระยะสุดท้าย

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-421-4303" alt="" src="/th/wp-content/uploads/2024/07/close\_small\_list\_cancer\_section\_4.png" class="ct-image"/\>

5

 อันดับ

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-446-4303" alt="" src="/th/wp-content/uploads/2024/07/Wording\_Critical\_illness.png" class="ct-image"/\>

ที่คนไทยเสียชีวิตมากที่สุด

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-451-4303" alt="" src="/th/wp-content/uploads/2024/07/Critical\_illness\_icon\_1.png" class="ct-image"/\>

โรคมะเร็ง

เสียชีวิต 7 คน/ชั่วโมง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-456-4303" alt="" src="/th/wp-content/uploads/2024/07/Critical\_illness\_icon\_2.png" class="ct-image"/\>

โรคหลอดเลือดสมองแตก

เสียชีวิต 3 คน/ชั่วโมง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-461-4303" alt="" src="/th/wp-content/uploads/2024/07/Critical\_illness\_icon\_3.png" class="ct-image"/\>

โรคหัวใจเต้นผิดจังหวะรุนแรง

เสียชีวิต 3 คน/ชั่วโมง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-466-4303" alt="" src="/th/wp-content/uploads/2024/07/Critical\_illness\_icon\_4.png" class="ct-image"/\>

โรคปอดระยะสุดท้าย

เสียชีวิต 2 คน/ชั่วโมง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-471-4303" alt="" src="/th/wp-content/uploads/2024/07/Critical\_illness\_icon\_5.png" class="ct-image"/\>

โรคไตวายเรื้อรัง

เสียชีวิต 2 คน/ชั่วโมง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-477-4303" alt="" src="/th/wp-content/uploads/2024/07/mark\_left\_for\_critical\_illness.png" class="ct-image"/\>

ถึงไม่มีกรรมพันธุ์ ก็ไม่ใช่ว่าจะไม่มีความเสี่ยง  
เพราะมลพิษฝุ่นควัน อาหารการกิน ความเครียดนั้นก็เป็นปัจจัยที่จะทำให้เกิดโรคร้ายตามมาได้

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-480-4303" alt="" src="/th/wp-content/uploads/2024/07/mark\_right\_for\_critical\_illness.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-546-4303" alt="" src="/th/wp-content/uploads/2024/07/why\_wording\_critical\_illness.png" class="ct-image"/\>

มีประกันสุขภาพแล้ว

ยังต้องซื้อประกันโรคร้ายแรง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-496-4303" alt="" src="/th/wp-content/uploads/2024/07/Icon\_Insurance\_Section\_5\_Critical\_illness.png" class="ct-image"/\>

ประกันโรคร้ายแรง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-499-4303" alt="" src="/th/wp-content/uploads/2024/07/Icon\_Insurance\_general.png" class="ct-image"/\>

ประกันสุขภาพ

จ่ายเงินก้อนให้กับ “เรา” ไว้ใช้เป็นค่าใช้จ่ายตอนป่วย  
ที่ทำงานไม่ได้

จ่ายค่ารักษาพยาบาลของเราให้กับ “โรงพยาบาล”  
ตามค่าใช้จ่ายที่เกิดขึ้นจริง

หรือปรึกษาวิธีซื้อประกันโรคร้ายแรง
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-541-4303" alt="" src="/th/wp-content/uploads/2024/07/Group\_smile\_image\_cancer\_left\_top.png" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-542-4303" alt="" src="/th/wp-content/uploads/2024/07/Group\_smile\_image\_cancer\_right\_bottom.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-573-4303" alt="" src="/th/wp-content/uploads/2024/07/prudential\_logo\_for\_cancer\_section\_3\_edit.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-578-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

จ่ายหลักร้อย คุ้มครองหลักล้าน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-581-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

คุ้มครองครบ หัวใจ สโตรค ไตวาย โคม่า

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-589-4303" alt="" src="/th/wp-content/uploads/2024/07/Combined\_Shape\_smile\_popup\_modal\_cancer.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-673-4303" alt="" src="/th/wp-content/uploads/2024/07/shield\_Critical\_illness\_Modal.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-655-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_critical\_illness\_modal.png" class="ct-image"/\>

กล้ามเนื้อหัวใจตายเฉียบพลันจากการขาดเลือด

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-658-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_critical\_illness\_modal.png" class="ct-image"/\>

โรคหลอดเลือดสมองแตกหรืออุดตัน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-661-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_critical\_illness\_modal.png" class="ct-image"/\>

ไตวายเรื้อรัง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-664-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_critical\_illness\_modal.png" class="ct-image"/\>
...
โรคร้ายหลบไป เลือกซื้อกลุ่มโรค  
ที่กังวลได้ถึง 6 กลุ่ม

รับประกันโดย เมืองไทยประกันชีวิต

สำหรับอายุ 20-59 ปี

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-802-4303" alt="" src="/th/wp-content/uploads/2024/07/mueng\_thai\_life\_logo\_for\_cancer\_section\_3\_edit.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-807-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

เจอ จ่าย สูงสุด 1 ล้านบาท  

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-810-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

เลือกซื้อตามกลุ่มโรคได้ หัวใจ ตับไต สมอง มะเร็ง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-869-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

คุ้มครองจนถึงอายุ 69 ปี

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-812-4303" alt="" src="/th/wp-content/uploads/2024/07/Combined\_Shape\_smile\_popup\_modal\_cancer.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-827-4303" alt="" src="/th/wp-content/uploads/2024/07/shield\_Critical\_illness\_Modal.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-829-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_critical\_illness\_modal.png" class="ct-image"/\>

กลุ่มโรคมะเร็ง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-832-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_critical\_illness\_modal.png" class="ct-image"/\>

กลุ่มโรคหลอดเลือดและหัวใจ

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-835-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_critical\_illness\_modal.png" class="ct-image"/\>

กลุ่มโรคการเปลี่ยนอวัยวะที่สำคัญ

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-838-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_critical\_illness\_modal.png" class="ct-image"/\>

กลุ่มโรคระบบประสาทและกล้ามเนื้อ

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-872-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_critical\_illness\_modal.png" class="ct-image"/\>

กลุ่มโรคอื่นๆ

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-875-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_critical\_illness\_modal.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-917-4303" alt="" src="/th/wp-content/uploads/2024/07/chevron-down\_critical\_illness.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-965-4303" alt="" src="/th/wp-content/uploads/2024/07/chevron-down\_critical\_illness.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1051-4303" alt="" src="/th/wp-content/uploads/2024/07/chevron-down\_critical\_illness.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1074-4303" alt="" src="/th/wp-content/uploads/2024/07/chevron-down\_critical\_illness.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1099-4303" alt="" src="/th/wp-content/uploads/2024/07/chevron-down\_critical\_illness.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1127-4303" alt="" src="/th/wp-content/uploads/2024/07/chevron-down\_critical\_illness.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1154-4303" alt="" src="/th/wp-content/uploads/2024/07/chevron-down\_critical\_illness.png" class="ct-image"/\>

กรณีเสียชีวิต คุ้มครอง 50,000 บาท

\*กรณีซื้อความคุ้มครองแบบระยะเริ่มต้นและระยะรุนแรง และไม่ได้เรียกร้องผลประโยชน์ความคุ้มครองระยะเริ่มต้นมาก่อน
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-720-4303" alt="" src="/th/wp-content/uploads/2024/07/mueng\_thai\_logo\_for\_cancer\_section\_3\_edit.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-725-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

รับเงินก้อนสูงสุด 5 แสน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-728-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

คุ้มครองครบทั้งมะเร็ง หัวใจ สมอง ปอด

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-787-4303" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

ต่ออายุได้ถึง 65 ปี

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-730-4303" alt="" src="/th/wp-content/uploads/2024/07/Combined\_Shape\_smile\_popup\_modal\_cancer.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-745-4303" alt="" src="/th/wp-content/uploads/2024/07/shield\_Critical\_illness\_Modal.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-747-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_critical\_illness\_modal.png" class="ct-image"/\>

โรคมะเร็งทุกระยะ (ไม่รวมโรคมะเร็งผิวหนัง ยกเว้นมะเร็งผิวหนังประเภท "เมลลาโนมา")

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-750-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_critical\_illness\_modal.png" class="ct-image"/\>

โรคกล้ามเนื้อหัวใจตายเฉียบพลัน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-753-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_critical\_illness\_modal.png" class="ct-image"/\>

โรคหลอดเลือดสมองแตกหรืออุดตัน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-756-4303" alt="" src="/th/wp-content/uploads/2024/07/check-circle-solid\_critical\_illness\_modal.png" class="ct-image"/\>
...
สิ่งที่ควรรู้ เมื่อซื้อประกันโรคร้ายแรง
----------

#### เงื่อนไขการซื้อประกันโรคร้ายแรง  ####

* ผู้ขอเอาประกันภัยสามารถทำประกันโรคร้ายแรงได้คนละ 1 ฉบับ
* รับประกันเฉพาะคนไทยที่มีสัญชาติไทยเท่านั้น
* รับประกันภัยด้วยการตอบคำถามสุขภาพ โดยไม่ต้องตรวจสุขภาพ
* ระยะรอคอย 90 วัน
* เบี้ยประกันภัยจะเพิ่มขึ้นตามช่วงอายุ
...
* โครงการเมืองไทย โรคร้ายแรง D Care คุ้มครองภายในระยะเวลา 10/10 และสัญญาเพิ่มเติมโรคร้ายแรง ดี แคร์ (D Care)
* รับประกันเฉพาะคนไทยที่มีสัญชาติไทยเท่านั้น
* รับประกันภัยด้วยการตอบคำถามสุขภาพ โดยไม่ต้องตรวจสุขภาพ
* ระยะรอคอย 90 วัน
...
* กรณีที่ผู้ขอเอาประกันภัยเลือกซื้อสัญญาเพิ่มเติมโรคร้ายแรง ดี แคร์ (D Care) กลุ่มโรคยอดฮิต ผู้ขอเอาประกันภัย ไม่สามารถขอซื้อสัญญาเพิ่มเติมโรคร้ายแรง ดี แคร์ (D Care) กลุ่มอื่นเพิ่มเติมได้อีก
...
* รับประกันภัยเฉพาะคนไทยที่มีสัญชาติไทยเท่านั้น
* รับประกันภัยด้วยการตอบคำถามสุขภาพ โดยไม่ต้องตรวจสุขภาพ
* ระยะรอคอย 90 วัน
* เบี้ยประกันภัยจะเพิ่มขึ้นตามช่วงอายุ
* ผู้เอาประกันภัยสามารถทำประกันภัยได้ คนละ 1 ฉบับ
* ไม่รับประกันภัยอาชีพที่มีความเสี่ยงสูง

#### เงื่อนไขการจ่ายค่าสินไหม  ####

ชดเชยสินไหมแบบเงินก้อน ตามจำนวนเงินแผนความคุ้มครอง เมื่อตรวจพบโรคใดโรคหนึ่งใน 4 โรคร้ายแรงเป็นครั้งแรก และกรมธรรม์ความคุ้มครองโรคร้ายแรงจะสิ้นสุดทันที

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/07/mueng\_thai\_life\_logo\_for\_cancer\_section\_3\_edit.png" style="width: 40px;height: 40px;margin-right: 12px;"\>เมืองไทยประกันชีวิต

เมื่อตรวจพบโรคใดโรคหนึ่งในกลุ่มโรคนั้นๆ ระยะเริ่มต้น เป็นครั้งแรก

* ชดเชยสินไหมแบบเงินก้อนตามจำนวนเงินแผนความคุ้มครองระยะเริ่มต้น โดยกรมธรรม์จะยังให้ความคุ้มครองต่อเนื่อง
* และจะชดเชยสินไหมแบบเงินก้อนให้อีกครั้งหากตรวจพบโรคใดโรคหนึ่งในกลุ่มโรคนั้นๆ ในระยะรุนแรง ตามจำนวนเงินแผนความคุ้มครองระยะรุนแรง โดยหักจำนวนเงินก้อนที่ได้รับในแผนความคุ้มครองระยะเริ่มต้น และกรมธรรม์ความคุ้มครองโรคร้ายแรงจะสิ้นสุดทันที

เมื่อตรวจพบโรคใดโรคหนึ่งในกลุ่มโรคนั้นๆ ระยะรุนแรง เป็นครั้งแรก

* ชดเชยสินไหมแบบเงินก้อน จำนวนเงินตามแผนความคุ้มครองระยะรุนแรงและ กรมธรรม์ความคุ้มครองจะสิ้นสุดทันที

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/07/mueng\_thai\_logo\_for\_cancer\_section\_3\_edit.png" style="width: 40px;height: 40px;margin-right: 12px;"\>เมืองไทยประกันภัย

ชดเชยสินไหมแบบเงินก้อน จำนวนเงินตามแผนความคุ้มครองเมื่อตรวจพบโรคใดโรคหนึ่งใน 4 โรคร้ายแรงเป็นครั้งแรกและ กรมธรรม์ความคุ้มครองจะสิ้นสุดทันที
...
} .add\_blur\_af::before { content: ""; display: block; position: absolute; top: -16px; width: 100%; height: calc(100% + -36px); background-image: linear-gradient(to bottom,rgba(29,29,29,0), #fff 80%); transition: opacity .5s;
}
.add\_blur\_af\_mobile::before { content: ""; display: block; position: absolute; top: -14px; width: 100%; height: calc(100% + -14px); background-image: linear-gradient(to bottom,rgba(29,29,29,0), #fff 80%); transition: opacity .5s;
}
.add\_blur\_af\_mobile.active::before,.add\_blur\_af.active::before { display: none;
