...
// Define the variable outside of any function to use it in clearInterval
var intervalId; function clearSVG(containerId) { var container = document.getElementById(containerId); // Remove all child nodes from the container (all SVG elements) while (container.firstChild) { container.removeChild(container.firstChild); }
} function startAnimations() { // Clear previous SVG and play the first animation clearSVG("h\_ic\_popup\_1"); var lottieContainerHome1 = document.getElementById("h\_ic\_popup\_1"); var animationDataHome1 = jsonhome1; lottie.loadAnimation({ container: lottieContainerHome1, renderer: 'svg', loop: false, autoplay: true, animationData: animationDataHome1 }); // Set timeout to switch to the second animation after 1.5 seconds setTimeout(function() { document.getElementById("h\_ic\_popup\_1").style.display = "none"; clearSVG("h\_ic\_popup\_2"); var lottieContainerHome2 = document.getElementById("h\_ic\_popup\_2"); var animationDataHome2 = jsonhome2; lottie.loadAnimation({ container: lottieContainerHome2, renderer: 'svg', loop: true, // changed to false to manage the loop via JavaScript autoplay: true, animationData: animationDataHome2 }); document.getElementById("h\_ic\_popup\_2").style.display = "block"; // After 10 seconds, switch back to the first animation setTimeout(function() { document.getElementById("h\_ic\_popup\_2").style.display = "none"; clearSVG("h\_ic\_popup\_1"); document.getElementById("h\_ic\_popup\_1").style.display = "block"; startAnimations(); // Recursively start the animation cycle again }, 7000); // This timeout controls the duration of the second animation }, 1200); // This timeout controls the delay before the second animation starts
} window.onscroll = function() { //console.log(window.scrollY); if(window.scrollY \<= 95){ $("#div\_block-1093-3766").fadeOut(); }else{ if(flaganimation) { $('#div\_block-1096-3766').css({ 'align-items': 'center', // Center align items vertically 'justify-content': 'center' // Center align items horizontally }) //console.log(jsonhome1); // Define the variable outside of any function to use it in clearInterval // Call the function to initiate the animation cycle
// startAnimations(); } flaganimation = false; $("#div\_block-1093-3766").fadeIn(); } }; });
...
คุ้มครองทั้งน้ำท่วม ไฟไหม้ และภัยธรรมชาติ
...
![](https://www.heygoody.com/th/wp-content/uploads/2024/05/line_dot_under_999_price_home_insurance.webp)

บาท/ปี

[ซื้อเลย](https://psmart.msig-thai.com/heygoody/baantanrak)

![](https://www.heygoody.com/th/wp-content/uploads/2024/08/banner-desktop_revamp_28082024.webp)![](https://www.heygoody.com/th/wp-content/uploads/2024/08/banner-mobile_revamp_28082024.webp)

รู้หรือไม่

![](/th/wp-content/uploads/2024/04/question_home_insurance.png)

ประกันบ้านคุ้มครองอะไรบ้าง
----------

ไม่ต้องไฟไหม้ก็เคลมได้ เพราะเรา...ไม่ได้คุ้มครองแค่ ความเสียหายจากเหตุไฟไหม้เท่านั้น

![](https://www.heygoody.com/th/wp-content/uploads/2024/08/protect-insur_home_insurance_1_1.png)

น้ำท่วม ท่อแตก น้ำซึม  

----------

ปลดกังวลของคนมีบ้าน น้ำท่วมจากภัยธรรมชาติคุ้มครองสูงสุด 120,000 หรือจะแค่น้ำรั่วซึม เราก็คุ้มครอง  

![](https://www.heygoody.com/th/wp-content/uploads/2024/07/protect-insur_revemp_icon_sec2_2.webp)

โจรงัดบ้าน
----------

เมื่อทรัพย์สินโดนยกเค้า หรือประตู หน้าต่างพังเพราะถูกงัด เราก็คุ้มครอง

![](https://www.heygoody.com/th/wp-content/uploads/2024/07/protect-insur_revemp_icon_sec2_3.webp)

เกิดอุบัติเหตุเสียชีวิต
----------

ซื้อประกันบ้าน แต่ได้ความคุ้มครอง  
ชีวิตด้วย สูงสุด 100,000 บาท

![](https://www.heygoody.com/th/wp-content/uploads/2024/07/protect-insur_revemp_icon_sec2_4.webp)

กระจกอาคารแตก
----------

กระจกร้าว ไม่ต้องตกใจ รู้หรือไม่?  
ประกันบ้านคุ้มครองให้ยันกระจก

![](https://www.heygoody.com/th/wp-content/uploads/2024/07/protect-insur_revemp_icon_sec2_5.webp)

หมากัด
----------

เพื่อนมาเยี่ยม โดนน้อนแง่ม ก็จ่ายค่า  
หมอให้เพื่อนได้

![](https://www.heygoody.com/th/wp-content/uploads/2024/07/protect-insur_revemp_icon_sec2_6.webp)

แก๊สระเบิด
----------

ตู้มต้าม เพราะลืมปิดแก๊ส ก็เคลมได้  

 document.addEventListener('DOMContentLoaded', () =\> { const scrollableElement = document.getElementById('div\_block-224-3766'); const customScrollbarThumb = document.getElementById('custom-scrollbar-thumb'); const customScrollbarContainer = document.getElementById('custom-scrollbar-container'); scrollableElement.addEventListener('scroll', () =\> { const maxScrollLeft = scrollableElement.scrollWidth - scrollableElement.clientWidth; const scrollLeft = scrollableElement.scrollLeft; const scrollPercent = scrollLeft / maxScrollLeft; const thumbWidth = customScrollbarThumb.offsetWidth; const trackWidth = customScrollbarContainer.offsetWidth; const maxThumbScroll = trackWidth - thumbWidth; customScrollbarThumb.style.transform = `translateX(${scrollPercent \* maxThumbScroll}px)`; }); const scrollableElementtable = document.getElementById('div\_block-435-3766'); scrollableElementtable.addEventListener('scroll', () =\> { const maxScrollLefttable = scrollableElementtable.scrollWidth - scrollableElementtable.clientWidth; const scrollLefttable = scrollableElementtable.scrollLeft; const scrollPercenttable = (scrollLefttable / maxScrollLefttable) \* 100; if(scrollPercenttable \> 0) { $("#hand-slide").fadeOut(); }
}); });

เมื่อเกิดเหตุไฟไหม้ น้ำท่วม และภัยธรรมชาติ

คุ้มครองครอบคลุม 

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-366-3766" alt="" src="/th/wp-content/uploads/2024/04/Font\_when\_accident\_home\_insurance.png" class="ct-image"/\>

### เมื่อเกิดเหตุ ก็เบิกได้ ###

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-373-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/Image\_all\_in\_home\_insurance\_sc\_3\_1.webp" class="ct-image"/\>

คุ้มครองความเสียหายตัวอาคาร   
และทรัพย์สินทั้งภายในและนอกอาคาร

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-375-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/Vector\_Image\_Section\_3\_home.webp" class="ct-image"/\>

### หลังเกิดเหตุ ก็เบิกได้ ###

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-388-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/Image\_in\_home\_insurance\_sc\_3\_1.webp" class="ct-image"/\>

#### ค่าดับเพลิง ####

ค่ารถดับเพลิง ค่าทำความสะอาด

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-395-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/Image\_in\_home\_insurance\_sc\_3\_2.webp" class="ct-image"/\>

#### ค่าขนย้ายซากทรัพย์สิน ####

ค่าใช้จ่ายในการขนย้ายซาก รื้อถอน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-412-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/Image\_in\_home\_insurance\_sc\_3\_3.webp" class="ct-image"/\>

#### ค่าประเมินราคาซ่อมบ้าน ####

ค่าออกแบบบ้าน และควบคุมงาน  
ที่ต้องซ่อม หรือสร้างใหม่ หลังไฟไหม้

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-417-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/Image\_in\_home\_insurance\_sc\_3\_4.webp" class="ct-image"/\>

#### ค่าเช่าบ้าน ระหว่างรอซ่อม ####

เมื่อต้องเช่าที่อยู่ระหว่างรอซ่อมแซม
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-429-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/icon-shield\_home\_insurance\_mobile.webp" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-439-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/msig\_logo\_table\_home\_insruance\_.webp" class="ct-image"/\>

รับประกันโดยเอ็มเอสไอจี ประกันภัย

[เงื่อนไขกรมธรรม์](/document/policy-wording/home)

ทุนประกันภัย   
สิ่งปลูกสร้าง และทรัพย์สิน

เบี้ยประกันภัยสิ่งปลูกสร้าง  
คอนกรีตล้วน (บาท/ปี)

เบี้ยประกันภัยสิ่งปลูกสร้าง  
ครึ่งตึกครึ่งไม้ (บาท/ปี)
...
![](https://www.heygoody.com/th/wp-content/uploads/2024/05/document_coverage_download_pdf_icon_h_insurance.webp)

ดูรายละเอียดความคุ้มครอง น้ำท่วม ไฟไหม้ และภัยพิบัติ   

](/th/wp-content/uploads/pdf_home_insurance_in_wp___.pdf)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-534-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/smile\_icon\_hgd\_home\_insurance\_left.webp" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-535-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/smile\_icon\_hgd\_home\_insurance\_right.webp" class="ct-image"/\>

เลือกแผนไม่ถูก?

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-662-3766" alt="" src="/th/wp-content/uploads/2024/04/Font\_dont\_\_home\_insurance\_.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-551-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/calculate\_icon\_home\_insurance\_.webp" class="ct-image"/\>

heygoody หาวิธีคำนวณมาให้แล้ว

1

บ้านของคุณเป็นแบบไหน?

เพราะประเภทของสิ่งปลูกสร้างมีผลกับค่าเบี้ยประกัน

(\*ไม่รับประกันบ้านที่เป็นไม้ล้วน หรือผนังเป็นไม้มากกว่า 50%)

คอนกรีตล้วน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-586-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/home\_concrete\_icon\_home\_insurance\_.webp" class="ct-image"/\>

คอนโดหรือบ้านที่ผนังเป็นคอนกรีต

ครึ่งตึกครึ่งไม้

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-591-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/home\_concrete\_wood\_icon\_home\_insurance\_.webp" class="ct-image"/\>

บ้านที่มีผนังไม้ น้อยกว่า 50%  
ของผนังบ้านทั้งหมด

2

ต้องซื้อทุนประกันเท่าไหร่ ?

เราแนะนำให้เลือกแผนประกันที่มีทุนประกันภัย

ครอบคลุมมูลค่าสิ่งปลูกสร้าง และทรัพย์สินของคุณ

วิธีคำนวณทุนประกันภัย

มูลค่าสิ่งปลูกสร้าง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-643-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/home\_and\_condo\_part\_cal\_home\_insurance.webp" class="ct-image"/\>

\+

มูลค่าทรัพย์สิน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-629-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/fer\_part\_cal\_home\_insurance.webp" class="ct-image"/\>

\=

เงินทุนประกันภัย

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-659-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/shield-5\_sum\_cal\_home\_insruance.webp" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-660-3766" alt="" src="/th/wp-content/uploads/2024/04/Line\_mint\_section\_5\_md\_home\_insurance\_.png" class="ct-image"/\>

ดูตัวอย่างคำนวณเลือกซื้อแผนประกันบ้าน/คอนโด

หรือปรึกษาวิธีซื้อประกันบ้าน/คอนโด
...
สิ่งที่ควรรู้ เมื่อซื้อประกันบ้าน
----------

 เรื่องควรรู้ก่อนซื้อ

สามารถซื้อประกันอัคคีภัยให้กับสิ่งปลูกสร้าง บ้าน/คอนโด ที่เราไม่ได้ถือกรรมสิทธิ์เป็นเจ้าของได้หรือไม่

ซื้อได้ หากผู้ซื้อเป็นผู้มีส่วนได้ส่วนเสียในทรัพย์สิน เช่น ผู้เช่าซื้อประกันให้ที่อยู่อาศัยที่ตัวเองเช่าอยู่

บุคคลใดบ้างที่ไม่สามารถซื้อประกันภัยบ้านได้

1. บุคคลที่ไม่มีส่วนได้ส่วนเสียในทรัพย์สิน

2. ชาวต่างชาติ ที่ไม่มีที่พำนักอาศัยในประเทศไทย

สามารถซื้อประกันอัคคีภัย ให้กับสิ่งปลูกสร้างที่เป็นไม้ล้วนได้หรือไม่

ไม่ได้ เนื่องจากแผนประกันนี้ไม่รับประกันสิ่งปลูกสร้างที่เป็นไม้ล้วน สามารถสังเกตประเภทสิ่งปลูกสร้างได้จากผนังหากผนัง มีไม้เป็นส่วนประกอบมากกว่า 50% จะถือเป็นสิ่งปลูกสร้างไม้ล้วน

สิ่งปลูกสร้าง (ไม่รวมฐานราก) หมายความว่าอะไร

หมายถึงสิ่งปลูกสร้างเฉพาะส่วนที่เป็นตัวตึก/อาคาร แต่ไม่รวมที่ดิน หรือส่วนที่อยู่ใต้ดินลงไป
สิ่งปลูกสร้างในที่นี้ หมายถึง ห้องชุดสำหรับอยู่อาศัยในแฟลต อาคารชุด คอนโดมิเนียม บ้าน ทาวน์เฮ้าส์ บ้านแฝดตึกแถวสำหรับอยู่อาศัย โรงรถ และอาคารย่อย (เช่น เรือนคนรับใช้ เรือนครัว) รวมไปถึงกำแพง รั้ว ประตู รวมทั้งส่วนปรับปรุงต่อเติม

อายุของสิ่งปลูกสร้าง มีผลต่อการรับประกันหรือไม่

อายุสิ่งปลูกสร้าง ไม่มีผลต่อการรับประกันภัย

หากมีการติดตั้งกล้องวงจรปิด จะได้รับส่วนลดหรือไม่

ไม่มีส่วนลดเพิ่มเติม

กรมธรรม์จะเริ่มคุ้มครอง และสิ้นสุดความคุ้มครองเวลาใด

ความคุ้มครองจะเริ่ม และสิ้นสุดเวลา16.30 ตามวันที่ระบุในหน้าตารางกรมธรรม์

สามารถเลือกซื้อแผนความคุ้มครองที่ทุนประกันสูงกว่ามูลค่าสิ่งปลูกสร้างปัจจุบันได้หรือไม่

สามารถซื้อได้ แต่ไม่แนะนำ เพราะการพิจารณาชดใช้ความเสียหาย จะพิจารณาจากมูลค่าความเสียหายที่เกิดขึ้นจริง การซื้อทุนประกันที่สูงเกินไปจะทำให้จ่ายค่าเบี้ยประกันเกินความจำเป็

สามารถทำประกันได้สูงสุดกี่ปี

ประกันภัยนี้เป็นสัญญาแบบปีต่อปี และสามารถต่ออายุได้เรื่อยๆ

สามารถเพิ่มชื่อผู้เอาประกันภายหลังได้หรือไม่ (กรณีมีผู้กู้ร่วมเพิ่ม)

สามารถแจ้งสลักหลังเพิ่มได้ โดยสามารถระบุได้สูงสุด 2 ท่าน

 ซื้ออย่างไร

ซื้อประกันอัคคีภัยอย่างไร ต้องเซ็นเอกสารหรือไม่

เนื่องจากเป็นแผนประกันภัยสามารถซื้อผ่านช่องทางออนไลน์ สามารถกดซื้อได้เลย ไม่ต้องเซ็นเอกสารใดๆ โดยเตรียมข้อมูลก่อนซื้อ 2 อย่างง่ายๆ ดังนี้

1. ต้องทราบประเภทสิ่งปลูกสร้างที่เอาประกันว่าเป็น คอนกรีต หรือครึ่งตึกครึ่งไม้ เพราะมีผลกับค่าเบี้ยประกันภัย

2. ต้องทราบมูลค่าของสิ่งปลูกสร้างในปัจจุบัน เพื่อเลือกแผนประกันให้ครอบคลุมความเสียหายที่อาจเกิดขึ้น

วิธีเลือกแผนประกัน และทุนประกันที่เหมาะสม

ควรเลือกแผนที่ให้ความคุ้มครองครอบคลุมมูลค่าปัจจุบันของสิ่งปลูกสร้าง และมูลค่าทรัพย์สินที่ต้องการให้รับประกัน

เราจะรู้มูลค่าของสิ่งปลูกสร้างปัจจุบันได้อย่างไร หากมีส่วนที่ต่อเติมจะต้องรวมมูลค่าเข้าไปด้วยหรือไม่

สามารถหามูลค่าสิ่งปลูกสร้างได้จากสูตร (กว้าง x ยาว x จำนวนชั้น) x มูลค่าสิ่งปลูกสร้างต่อตารางเมตร หากมีส่วนต่อเติมจะต้องรวมมูลค่าของส่วนที่ต่อเติมเข้าไปให้ด้วยหรือสามารถคำนวนได้จากเวปไซต์นี้

[

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/04/k\_p\_s\_logo\_home\_insurance\_.png" style="width: 40px; height: 40px;border-radius: 8px;"\>

สำนักงานคณะกรรมการกำกับและส่งเสริมการประกอบธุรกิจประกันภัย (คปภ.)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="https://www.heygoody.com/th/wp-content/uploads/2024/03/link-out\_travel\_update\_icon.png" style="width: 24px; height: 24px;"\>

](http://oiceservice.oic.or.th/insurancefire/Calculator.php)

จะได้รับกรมธรรม์ช่องทางใด หากต้องการเปลี่ยนแปลงข้อมูลจัดส่งกรมธรรม์จะต้องทำอย่างไร

ลูกค้าที่ทำรายการผ่านช่องทางออนไลน์จะได้รับ ePolicy ผ่านอีเมลที่แจ้งไว้ ทั้งนี้หาลูกค้าประสงค์รับเอกสารทางไปรษณีย์ สามารถกดเลือกให้บริษัทฯ จัดส่งไปให้ตามที่อยู่ได้ หากต้องการแก้ไขปลี่ยนแปลงข้อมูล

ติดต่อสอบถามบริษัทประกัน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img src="/th/wp-content/uploads/2024/04/msig\_logo\_table\_home\_insruance\_.png" style="width: 40px; height: 40px;border-radius: 8px;background-color: #fff;"\>

เอ็มเอสไอจีประกันภัย

โทร: [02 007 9004](tel:+6620079004)

เวลาทำการ วันจันทร์ - ศุกร์ 8.30- 21.00น. วันเสาร์ 9.30 - 18.00 น.

ได้รับกรมธรรม์ภายในกี่วัน หลังจากซื้อสำเร็จ

e-Policy จะถูกจัดส่งภายใน 1 ชั่วโมงหลังทำรายการซื้อสำเร็จ หากเลือกรับเอกสารทางไปรษณีย์จะได้รับภายใน 15 วันทำการ

สามารถชำระค่าเบี้ยประกัน แบบผ่อนจ่ายกับเงินติดล้อได้หรือไม่ และผ่อนกับบัตรเครดิตใดได้บ้าง

กรณีซื้อผ่านช่องทางออนไลน์จะไม่สามารถผ่อนชำระได้ ต้องจ่ายเต็มจำนวนเท่านั้น

หากต้องการความคุ้มครองประกันอัคคีภัยในปีถัดไป ต้องทำอย่างไร

ลูกค้าจะได้รับจดหมายใบเตือนต่ออายุ รวมถึงการติดต่อจากบริษัทประกันภัยเพื่อแจ้งเตือนสำหรับปีต่อายุ โดยลูกค้า จะต้องชำระค่าเบี้ยประกันภัยตามเงื่อนไขระบุบนใบเตือน เพื่อได้รับความคุ้มครองที่ต่อเนื่อง

หากบ้านยังมีภาระสินเชื่อผูกพันกับธนาคาร (สินเชื่อ) สามารถระบุชื่อผู้รับประโยชน์เป็นบุคคลในครอบครัวได้หรือไม่

หากบ้านยังมีภาระสินเชื่อผูกพันธ์กับธนาคาร จะต้องระบุชื่อธนาคารเป็นผู้รับประโยชน์เท่านั้น

 แบบนี้เคลมได้ไหม

หากเด็กวิ่งชนกระจกแตก จะได้รับความคุ้มครองในหมวดกระจกหรือไม่

ได้รับความคุ้มครอง แต่กระจกที่ได้รับความเสียหาย จะต้องเป็นกระจกที่ติดตั้งตรึงตรา และเป็นส่วนหนึ่งของตัวอาคาร หากเป็นกระจกเงา (กระจกส่อง) จะไม่ได้รับความคุ้มครองในหมวดนี้ และครอบคลุมถึงค่ารักษาพยาบาล ที่เกิดขึ้นหากบุคคลภายนอกได้รับบาดเจ็บจากเหตุกระจกแตก เป็นต้น

กรณีไม่มีคนอยู่อาศัย หรือดูแลบ้านเกิน 7 วัน และบ้านถูกโจรกรรม ทรัพย์สินสูญหาย จะสามารถเรียกร้องความเสียหายได้หรือไม่

หากบ้านถูกทิ้งร้างเกิน 7 วัน จะไม่สามารถเรียกร้องได้ในหมวดความคุ้มครองการโจรกรรม

หากเพลิงไหม้ที่เกิดกับสิ่งปลูกสร้างที่เอาประกัน ลุกลามไปบ้านข้างเคียง หรือได้รับความเสียหายจากการพยายามดับเพลิงนั้น เช่น ต้องทุบกำแพงข้างบ้านเพื่อไปดับไฟ จะได้รับความคุ้มครองด้วยหรือไม่

ได้รับความคุ้มครอง ในหมวดความรับผิดต่อบุคคลภายนอก โดยจะชดเชยทรัพย์สินที่เสียหายจริงของบ้านข้างเคียง แต่ไม่เกินทุนประกันภัยระบุ

กรณีเรียกร้องสินไหมในส่วนทรัพย์สิน จะใช้วิธีประเมินมูลค่า และชดใช้ความเสียหายอย่างไร

พิจารณาจากความเสียหายที่เกิดขึ้นจริง โดยชดเชยด้วยวิธีซ่อมแซมให้กับคืนสภาพเดิม หรือชดเชยตามมูลค่าทรัพย์สิน ณ ปัจุบัน

สามารถเรียกร้องค่าเสียหายที่เกิดจากน้ำท่วมได้หรือไม่

สามารถเรียกร้องได้จากหมวดความคุ้มครองกลุ่มภัยธรรมชาติ และ หมวดภัยจากน้ำท่วม ทุนประกันน้ำท่วมรวมสูงสุด 120,000 บาท ทั้งนี้แต่ไม่เกินจำนวนทุนประกันที่แสดงที่หน้าตาราง

กรณีเรียกร้องสินไหมทรัพย์สินส่วนบุคคล ต้องใช้เอกสารใดยืนยันว่าทรัพย์สินนั้นมีอยู่จริง

ใช้หลักฐานใบแจ้งความ หรือรูปถ่าย ใบเสร็จ เพื่อยืนยันความเสียหาย

เกิดน้ำรั่วซึมภายห้องของคอนโดที่พักอาศัย ทำให้ทรัพย์สินที่ทำประกันภัยเสียหายสามารถเคลมได้หรือไม่

สามารถเคลมได้ในหมวดภัยเนื่องจากน้ำ

กรณีลมพายุพัด จนทำให้ต้นไม้ในสวนหลังบ้านหักโค่นไปทับกำแพงของบ้านหลังข้างๆ จะสามารถเคลมได้หรือไม่

สามารถเคลมทรัพย์สินของเพื่อนบ้านที่เสียหายจากต้นไม้ไปทับ ในหมวดความรับผิดต่อบุคคลภายนอก สำหรับความเสียหายของทรัพย์สิน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-703-3766" alt="" src="/th/wp-content/uploads/2024/04/close\_modal\_popup\_home\_insurance\_.png" class="ct-image" data-bs-dismiss="modal"/\>

ตัวอย่างการคำนวณ

เลือกซื้อแผนประกันบ้าน/คอนโด

1

#### คำนวนมูลค่าสิ่งปลูกสร้าง ####

บ้าน

[ กว้าง 10 เมตร x ยาว 20 เมตร x 1 ชั้น ]

x 15,000 บาท

(ราคาประเมินสิ่งปลูกสร้างปัจจุบัน/ตารางเมตร)

\=

3,000,000 บาท

(มูลค่าบ้านไม่รวมที่ดิน)
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-797-3766" alt="" src="/th/wp-content/uploads/2024/04/Line\_mint\_section\_5\_md\_home\_insurance\_.png" class="ct-image"/\>

ดูราคาประเมินสิ่งปลูกสร้างปัจจุบันต่อตารางเมตร
...
บ้านเดี่ยว/บ้านแฝด/ทาวเฮ้าส์

12,000

19,000

คอนโด/อพาร์ทเม้นท์ น้อยกว่า 10 ชั้น

11,000

18,000

คอนโด/อพาร์ทเม้นท์ มากกว่า 10 ชั้น
...
หมายเหตุ : ราคาประเมินมูลค่าสิ่งปลูกสร้าง ไม่รวมรากฐาน

2

#### คำนวณเงินทุนประกันภัย ####

นำมูลค่าสิ่งปลูกสร้าง รวมกับมูลค่าทรัพย์สินภายในบ้าน เท่านี้ก็จะได้เงินทุนประกันภัย
...
เงินทุนประกันภัยเท่ากับ

3,600,000 บาท

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1086-3766" alt="" src="/th/wp-content/uploads/2024/04/coin\_addon\_popup\_home\_insurance\_.png" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-951-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/Combined-Shape\_smile\_background\_modal\_h\_insurance\_resize.webp" class="ct-image"/\>

แผนประกันที่

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-956-3766" alt="" src="/th/wp-content/uploads/2024/04/rec\_wording\_home\_insurance\_modal\_.png" class="ct-image"/\>

ให้ครอบคลุมมูลค่าสิ่งปลูกสร้าง และทรัพย์สิน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-973-3766" alt="" src="/th/wp-content/uploads/2024/04/Frame\_db\_c\_1\_left\_home\_insurance\_.png" class="ct-image"/\>

แผน 7 เบี้ยประกันราคา 4,243 บาท/ปี 

สำหรับบ้าน “คอนกรีตล้วน”

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-975-3766" alt="" src="/th/wp-content/uploads/2024/04/Frame\_db\_c\_1\_right\_home\_insurance\_.png" class="ct-image"/\>

รับประกันโดย

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1014-3766" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/05/msig\_logo\_table\_home\_insruance\_.webp" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1214-5338" alt="" src="https://www.heygoody.com/th/wp-content/uploads/2024/07/img-home-popup-bottom-left-buy-section.webp" class="ct-image"/\>

ประกันบ้านคุ้มครองน้ำท่วม  
...
](https://psmart.msig-thai.com/heygoody/baantanrak)
...
}());  document.addEventListener('DOMContentLoaded', function() { // หน่วงเวลาโหลด jQuery (10 วินาที) setTimeout(function() { var script = document.createElement('script'); script.src = 'https://www.heygoody.com/th/wp-includes/js/jquery/jquery.min.js'; document.body.appendChild(script); }, 10000); // หน่วงเวลาโหลด New Relic (10 วินาที) setTimeout(function() { var script = document.createElement('script'); script.src = 'https://js-agent.newrelic.com/nr-spa-1.281.0.min.js'; document.body.appendChild(script); }, 10000); }); // Listen for the scroll event
/\*
window.addEventListener('scroll', function() { document.querySelectorAll('.parallax-effect').forEach(function(element, index) { const speed = (window.scrollY \* 0.265) / (index + 1); const scale = Math.max(1 - (window.scrollY \* 0.00025) / (index + 1), 0.22); const opacity = Math.max(1 - (window.scrollY \* 0.002) / (index + 1), 0.15); element.style.opacity = opacity; element.style.transform = `translateY(${speed}px) scale(${scale})`; }); document.querySelectorAll('.parallax-effect-home').forEach(function(element, index) { const speed = (window.scrollY \* 0.05) / (index + 1); const scale = Math.max(1 - (window.scrollY \* 0.00015) / (index + 1), 0.1); //const opacity = Math.max(1 - (window.scrollY \* 0.002) / (index + 1), 0.15); //element.style.opacity = opacity; element.style.transform = `translateY(${speed}px) scale(${scale})`; });
});
\*/
function togglePushDataLayer(button,topic) { if(button.classList.contains('collapsed')) { PushDataLayer('home', 'homeinsurance', 'close', 'things\_to\_know', topic); } else { PushDataLayer('home', 'homeinsurance', 'view', 'things\_to\_know', topic); }
} function PushDataLayer(event,cate,act,label,topic){ dataLayer.push({ event: event, event\_category: cate, event\_action: act, event\_label: label, topic: topic });
}:root{scroll-behavior: unset !important;}
html,body { font-family: 'notosansthai'!important; background-color: #ffffff !important; text-size-adjust: none !important; font-size-adjust: none !important; -webkit-text-size-adjust: none !important; -ms-text-size-adjust: none !important; -moz-text-size-adjust: none !important; }
#section-2-3766 \> .ct-section-inner-wrap { align-items: center;
}
@keyframes slideFromCenterToRight { 0% { transform: translateX(0%) } 100% { transform: translateX(-1451px) }
}
@media screen and (min-width: 768px) and (max-width: 1024px) { /\* Tablet Detected \*/ #div\_block-435-3766 { overflow-x: auto; } #section-421-3766 \> .ct-section-inner-wrap { padding-left: 0px; padding-right: 0px; } }
@media screen and (max-width: 767px) { /\* Mobile Detected \*/ #div\_block-435-3766 { overflow-x: auto; } #section-421-3766 \> .ct-section-inner-wrap { padding-left: 0px; padding-right: 0px; }
}
@media screen and (max-width: 1199px) { #div\_block-224-3766 { overflow-x: scroll; overflow-y: hidden; overscroll-behavior: none; } #div\_block-435-3766 { overflow-x: auto; } #section-218-3766 \> .ct-section-inner-wrap { padding-right: 0px; padding-left: 0px; } #section-421-3766 \> .ct-section-inner-wrap { padding-left: 0px; padding-right: 0px; }
} #div\_block-103-3766 { overflow-x: auto; }
.parallax-effect { transition: transform 0.5s ease-out, opacity 0.5s ease-out;
}
.parallax-effect-home { transition: transform 0.7s ease-out;
}
#div\_block-224-3766::-webkit-scrollbar,#div\_block-435-3766::-webkit-scrollbar { display: none; /\* This hides the scrollbar \*/
} #div\_block-224-3766,#div\_block-435-3766 { -ms-overflow-style: none; /\* IE and Edge \*/ scrollbar-width: none; /\* Firefox \*/
} .collapsible { transition: max-height 0.5s ease-out; /\* Smooth transition \*/ max-height: 0; /\* Initially hide the content \*/
}var flag = 0;
function toggleCollapsible() { var collapsible = document.getElementById("collapsible"); var arrow = document.querySelector('.arrow'); if (collapsible.style.display == "none" || flag == 0) { flag = 1; dataLayer.push({ event: "home", event\_category: "homeinsurance", event\_action: "view", event\_label: "price\_evaluation" }); collapsible.style.display = "block"; } else { dataLayer.push({ event: "home", event\_category: "homeinsurance", event\_action: "close", event\_label: "price\_evaluation" }); collapsible.style.display = "none"; } if (collapsible.style.maxHeight) { collapsible.style.maxHeight = null; arrow.classList.remove('rotate'); } else { collapsible.style.maxHeight = collapsible.scrollHeight + "px"; arrow.classList.add('rotate'); }
}.arrow::before { display: inline-block; width: 24px; height: 24px; content: ""; background-image: url('/th/wp-content/uploads/2024/04/chevron-down\_default\_home\_insurance\_modal\_green.png'); background-size: 100%; transition: transform 0.5s ease;
}
.arrow { cursor: pointer; user-select: none;
}
.arrow.rotate::before { transform: rotate(180deg);
}div.accordion-item { background: transparent !important; border: unset !important; border-bottom: 1px solid rgba(255, 255, 255, 0.10) !important;
}
h3.accordion-header { background: transparent !important;
}
.accordion-header \> button \> div { font-family: "Noto Sans Thai"; font-size: 18px; font-style: normal; font-weight: 700; line-height: normal; } button.accordion-button { padding: 16px 0px; color: var(--text-body-on-dark, #F9F9F4); font-family: "Noto Sans Thai"; font-size: 20px; font-style: normal; font-weight: 700; line-height: normal; background: transparent !important;
}
.word\_bottom\_condition { margin: 0; color: #F9F9F4; font-family: Sarabun; font-size: 16px; font-style: normal; font-weight: 400; line-height: 26px;
}
.word\_bottom\_condition.h { font-size: 18px; font-style: normal; font-weight: 700; line-height: 29px; padding: 8px 0px;
}
...
@media screen and (min-width: 768px) and (max-width: 1024px) { button.accordion-button { font-size: 16px; } .accordion-header \> button \> h3 { font-size: 14px; } .word\_bottom\_condition { font-size: 14px; line-height: 23px; } .word\_bottom\_condition.h { font-size: 14px; line-height: 23px; padding: 16px 0px; }
}
@media screen and (max-width: 767px) { button.accordion-button { font-size: 16px; } .accordion-header \> button \> h3 { font-size: 14px; } .word\_bottom\_condition { font-size: 14px; line-height: 23px; } .word\_bottom\_condition.h { font-size: 14px; line-height: 23px; padding: 16px 0px; }
