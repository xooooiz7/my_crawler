...
function togglePushDataLayer(elementId, eventValue) { var h2Element = document.getElementById(elementId); var button = h2Element.querySelector('.accordion-button'); if(button.classList.contains('collapsed')) { PushDataLayer('tax\_btn', 'tax\_saving', 'close', 'things\_to\_know', eventValue); } else { PushDataLayer('tax\_btn', 'tax\_saving', 'view', 'things\_to\_know', eventValue); }
} function PushDataLayer(event,cate,act,label,tp){ dataLayer.push({ event: event, event\_category: cate, event\_action: act, event\_label: label, topic: tp });
}
...
เงินต้นไม่หาย ได้ผลตอบแทน

ลดหย่อนภาษีสูงสุด 1 แสนบาท

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-16-4464" alt="" src="/th/wp-content/uploads/2024/09/heading\_image\_saving\_page.webp" class="ct-image no-lazy" fetchpriority="high"/\>![](/th/wp-content/uploads/2024/09/heading_image_saving_page_mobile_x2.webp)

ประกันสะสมทรัพย์ คืออะไร
----------

เครื่องมือสำหรับการวางแผนการเงิน ที่ผสมผสาน ระหว่างความคุ้มครองชีวิตและการออมเงินไว้ด้วยกัน

ตัวอย่างการจ่ายเบี้ยและรับผลประโยชน์

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-51-4464" alt="" src="/th/wp-content/uploads/2024/09/table\_benefit\_section\_2\_tax\_saving.webp" class="ct-image"/\>

ได้รับเงินคืนระหว่างสัญญา ตามสัดส่วนของทุนประกันชีวิต ประมาณ 1% - 20% ตามแผนประกันที่เลือกซื้อ เมื่อครบรอบปีกรมธรรม์แรกทันที และจะได้รับเงินก้อนใหญ่ ในปีที่กรมธรรม์สิ้นสุดความคุ้มครอง

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-92-4464" alt="" src="/th/wp-content/uploads/2024/09/svg\_double\_quote\_down\_left\_saving\_page.svg" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-93-4464" alt="" src="/th/wp-content/uploads/2024/09/svg\_double\_quote\_down\_right\_saving\_page.svg" class="ct-image"/\>

อยากจ่ายเบี้ยกี่ปี ก็มีให้เลือกครบ

ซื้อเสร็จ แอด LINE @heygoody

รับ

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-4665-4464" alt="" src="/th/wp-content/uploads/2024/10/grab\_icon\_tax\_calculate\_page.svg" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-4669-4464" alt="" src="/th/wp-content/uploads/2024/10/whisper\_icon\_toppage\_calculate\_page.webp" class="ct-image"/\>

[

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-4672-4464" alt="" src="/th/wp-content/uploads/2024/09/line\_icon\_tax\_calculate\_page\_x2.webp" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-4673-4464" alt="" src="/th/wp-content/uploads/2024/10/good\_icon\_toppage\_calculate\_page.webp" class="ct-image"/\>

แอด LINE

](/th/addfriend/?campaign=linefriend&product=saving)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-102-4464" alt="" src="/th/wp-content/uploads/2024/09/rbl\_logo\_tax\_saving\_page.webp" class="ct-image"/\>
...
\#วางแผนง่ายจ่ายปีเดียว

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-107-4464" alt="" src="/th/wp-content/uploads/2024/09/Combined\_Shape\_Section\_3\_tax\_saving.webp" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-111-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

สายฟรีแลนซ์วางแผนง่าย

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-114-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

จ่ายเบี้ยครั้งเดียวจบ ไม่มีภาระผูกพัน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-117-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

ผลตอบแทนเฉลี่ยต่อปี (IRR) สูง 2.1%
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-4629-4464" alt="" src="/th/wp-content/uploads/2024/07/fire\_logo\_for\_cancer\_section\_3.png" class="ct-image"/\>

กระเป๋ามูลค่า 4,690 ถึง 31 ธ.ค.67
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-141-4464" alt="" src="/th/wp-content/uploads/2024/09/tcap\_logo\_tax\_saving\_page\_\_.webp" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-146-4464" alt="" src="/th/wp-content/uploads/2024/09/Combined\_Shape\_Section\_3\_tax\_saving.webp" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-150-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

สายฟรีแลนซ์วางแผนง่าย

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-153-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

จ่ายเบี้ยสั้นแค่ 2 ปี

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-156-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

รับเงินคืนระหว่างสัญญาปีละ 5%\*

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-4771-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image
ปี

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1271-4464" alt="" src="/th/wp-content/uploads/2024/09/check-small\_saving\_page.svg" class="ct-image"/\>

100,000

(เงินสดเท่านั้น)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1317-4464" alt="" src="/th/wp-content/uploads/2024/09/star-solid\_saving\_page.svg" class="ct-image"/\>

แนะนำ

2.40%

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1428-4464" alt="" src="/th/wp-content/uploads/2024/09/star-solid\_saving\_page.svg" class="ct-image"/\>

แนะนำ

ปีที่1ปีที่2ปีที่3ปีที่4ปีที่5ปีที่6ปีที่7ปีที่8ปีที่9ปีที่10

\==========

115%215%315%415%515%515%415%315%215%145%

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1547-4464" alt="" src="/th/wp-content/uploads/2024/09/star-solid\_saving\_page.svg" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1621-4464" alt="" src="/th/wp-content/uploads/2024/09/check-small\_saving\_page.svg" class="ct-image"/\>

150%

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1649-4464" alt="" src="/th/wp-content/uploads/2024/09/close-small\_saving\_page.svg" class="ct-image"/\>

รายปี

โอนผ่านบัญชีธนาคาร

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-2381-4464" alt="" src="/th/wp-content/uploads/2024/09/PoseG\_hand\_coin\_right\_saving\_page.webp" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-2382-4464" alt="" src="/th/wp-content/uploads/2024/09/Coin\_blur\_top\_saving\_page\_.webp" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-2383-4464" alt="" src="/th/wp-content/uploads/2024/09/Coin\_blur\_top\_saving\_page.webp" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-2384-4464" alt="" src="/th/wp-content/uploads/2024/09/Coin\_blur\_left\_saving\_page.webp" class="ct-image"/\>

### สิ่งที่ควรรู้ เมื่อซื้อประกันสะสมทรัพย์ ###

#### ประกันสะสมทรัพย์คืออะไร  ####

* ประกันสะสมทรัพย์ คือ แผนประกันชีวิตที่ให้ผู้เอาประกันชำระค่าเบี้ยประกันเป็นงวด ๆ เน้นเรื่องการเก็บเงินไปเรื่อย ๆ ควบคู่กับการให้ความคุ้มครองชีวิต โดยผู้เอาประกันจะชำระค่าเบี้ยประกันเป็นงวด ๆ ให้กับบริษัทประกัน และบริษัทประกันชีวิต จะจ่ายเป็นเงินก้อนคืนให้กับผู้เอาประกันเมื่อจบสัญญา ตามแผนประกันที่เลือกซื้อกำหนด แต่หากผู้เอาประกันเสียชีวิต ครอบครัวข้างหลังก็จะได้รับเงินเอาประกัน ตามที่ระบุไว้ในกรมธรรม์   
* ประกันชีวิตแบบสะสมทรัพย์ไม่ใช่การลงทุน หรือการฝากเงิน และมีข้อจำกัดในการเวนคืนกรมธรรม์ ซึ่งอาจทำให้ผู้เอาประกันภัยได้รับเงินน้อยกว่าเบี้ยประกันภัยที่ชำระมาแล้ว   
* เบี้ยประกันชีวิตแบบสะสมทรัพย์สามารถนำไปลดหย่อนภาษีได้ตามกฎหมายสูงสุด 100,000 บาท

#### กรณีใดบ้างที่บริษัทจะไม่คุ้มครอง  ####

* กรณีไม่เปิดเผยข้อความจริง หรือแถลงข้อความเท็จ บริษัทฯ จะบอกล้างค่าสัญญาภายใน 2 ปี นับแต่วันเริ่มมีผลคุ้มครองตามกรมธรรม์ประกันภัย   
* ฆ่าตัวตายภายใน 1 ปี นับแต่วันเริ่มมีผลคุ้มครองตามกรมธรรม์ประกันภัย หรือถูกผู้รับประโยชน์ฆ่าตาย

#### การตอบคำถาม FATCA คืออะไร  ####

FATCA เป็นกฎหมายที่ออกโดยสหรัฐอเมริกา เพื่อป้องกันการลบเลี่ยงภาษีของบุคคลที่มีสถานะเป็นบุคคลอเมริกัน ซึ่งรัฐบาลไทยและรัฐบาลสหรัฐอเมริกาได้มีการทำสัญญาร่วมกัน (IGA) ในเรื่องของ FATCA ดังนั้น บริษัทฯจำเป็นต้องขอข้อมูลดังกล่าวเพิ่มเติม เพื่อรายงานข้อมูลของลูกค้าที่มีสถานะเป็นบุคคลอเมริกัน ตามเงื่อนไขที่กฎหมายกำหนด

#### หากไม่ได้รับเอกสารกรมธรรม์ภายในปีที่ซื้อ จะสามารถใช้สิทธิลดหย่อนภาษีได้หรือไม่  ####

หากกรมธรรม์ได้รับการอนุมัติรับประกัน จะสามารถใช้สิทธิลดหย่อนภาษีได้ เนื่องจากบริษัทประกันจะออกใบเสร็จรับเงินเป็นวันที่ชำระเงินสำเร็จ

#### วิธีการจัดส่งกรมธรรม์  ####

<img class="no-lazyload" src="/th/wp-content/uploads/2024/09/rbl_logo_tax_saving_page.webp" width="40" height="40"> แรบบิท ไลฟ์ ประกันชีวิต

ผู้เอาประกันจะได้รับเล่มกรมธรรม์แบบกระดาษ โดยกรมธรรม์จะถูกจัดส่งไปยังที่อยู่ตามระบุ ในขั้นตอนการทำรายการซื้อ หลังจากได้รับการพิจารณาอนุมัติ

<img class="no-lazyload" src="/th/wp-content/uploads/2024/09/tcap_logo_tax_saving_page__.webp" width="40" height="40"> ที ไลฟ์ ประกันชีวิต

ผู้เอาประกันจะได้รับเล่มกรมธรรม์แบบกระดาษ โดยกรมธรรม์จะถูกจัดส่งไปยังที่อยู่ตามระบุ ในขั้นตอนการทำรายการซื้อ หลังจากได้รับการพิจารณาอนุมัติ

<img class="no-lazyload" src="/th/wp-content/uploads/2024/09/mtl_logo_tax_saving_page.webp" width="40" height="40"> เมืองไทยประกันชีวิต

สามารถเลือกรับกรมธรรม์แบบ e-Policy หรือกรมธรรม์แบบกระดาษ หลังจากกรมธรรม์ได้รับการพิจารณาอนุมัติแล้วกรมธรรม์จะถูกจัดส่งให้ทางอีเมล หรือที่อยู่ตามระบุในขั้นตอนการทำรายการซื้อ

<img class="no-lazyload" src="/th/wp-content/uploads/2024/09/pru_logo_tax_saving_page.webp" width="40" height="40"> พรูเด็นเชียล ประกันชีวิต

บริษัทฯ จะส่ง SMS แจ้งได้รับคำขอประกันภัย หลังจากนั้นบริษัทฯ จะส่ง SMS แจ้งการได้รับอนุมัติแก่ผู้ขอเอาประกันภัยภายใน 1-2 วันทำการถัดไป และเริ่มความคุ้มครอง สำหรับกรณีที่ใบคำขอเอาประกันภัยไม่ได้รับการพิจารณาอนุมัติ ผู้ขอเอาประกันภัยจะได้รับเบี้ยประกันภัยคืนเต็มจำนวนผ่านช่องทางที่ทำการชำระเบี้ย

#### วิธีการชำระเบี้ยประกันภัยในงวดปีถัดไป  ####

<img class="no-lazyload" src="/th/wp-content/uploads/2024/09/rbl_logo_tax_saving_page.webp" width="40" height="40"> แรบบิท ไลฟ์ ประกันชีวิต

ผู้เอาประกันจะได้รับการแจ้งเตือนทาง SMS ล่วงหน้า 30 วัน ก่อนถึงวันกำหนดชำระจากบริษัทประกัน โดยผู้เอาประกันสามารถชำระเบี้ยประกันออนไลน์ผ่านลิงค์ bill payment ที่แนบมาให้ทาง SMS

<img class="no-lazyload" src="/th/wp-content/uploads/2024/09/tcap_logo_tax_saving_page__.webp" width="40" height="40"> ที ไลฟ์ ประกันชีวิต

ผู้เอาประกันจะได้รับการแจ้งเตือนทาง SMS และทางจดหมายแจ้งเตือน ล่วงหน้าเป็นเวลา 20 วัน ก่อนถึงวันกำหนดชำระ โดยผู้เอาประกันภัยสามารถชำระเบี้ยประกันผ่าน bill payment ที่ได้รับทางจดหมายแจ้งเตือน   

กรณีต้องการเปลี่ยนแปลงวิธีการชำระเบี้ยประกันให้เป็นการหักจากบัญชีออมทรัพย์ ผู้เอาประกันสามารถติดต่อบริษัทประกันเพื่อทำเรื่องเปลี่ยนแปลงได้

<img class="no-lazyload" src="/th/wp-content/uploads/2024/09/mtl_logo_tax_saving_page.webp" width="40" height="40"> เมืองไทยประกันชีวิต

กรณีที่ลูกค้าชำระเบี้ยประกันภัยปีแรกผ่านบัตรเครดิต ระบบจะหักผ่านบัตรเครดิตเดิม โดยจะเรียกเก็บทุกวันที่ 20 ของทุกเดือน หากไม่สามารถดำเนินการได้ จะทำการเรียกเก็บอีกครั้งในวันที่ 5 ของเดือนถัดไป  

กรณีที่ลูกค้าชำระเบี้ยประกันภัยปีแรกผ่าน QR Code เงินสด ผู้เอาประกันจะได้รับการแจ้งเตือนทาง SMS ล่วงหน้า 30 วัน ก่อนถึงวันกำหนดชำระจากบริษัทประกัน โดยผู้เอาประกันสามารถชำระเบี้ยประกันออนไลน์ผ่านลิงค์ bill payment ที่แนบมาให้ทาง SMS

<img class="no-lazyload" src="/th/wp-content/uploads/2024/09/pru_logo_tax_saving_page.webp" width="40" height="40"> พรูเด็นเชียล ประกันชีวิต

กรณีมีการเพิ่มเพื่อนในบัญชี LINE ผู้เอาประกันจะได้รับการแจ้งเตือนทาง LINE ล่วงหน้า 20 วัน ก่อนถึงวันกำหนดชำระ และจะได้รับการแจ้งเตือนทาง SMS ล่วงหน้า 7 วัน โดยผู้เอาประกันสามารถชำระเบี้ยประกันออนไลน์ผ่านลิงค์ bill payment ที่แนบมาให้ทาง SMS

#### ติดต่อบริษัทประกัน  ####

<img class="no-lazyload" src="/th/wp-content/uploads/2024/09/rbl_logo_tax_saving_page.webp" width="40" height="40">

แรบบิท ไลฟ์ ประกันชีวิต

โทร: [02-648-3600](tel:026483600)

 Line: [@rabbit\_life](https://line.me/R/ti/p/@rabbit_life)  
 ตลอด 24 ชั่วโมง

<img class="no-lazyload" src="/th/wp-content/uploads/2024/09/tcap_logo_tax_saving_page__.webp" width="40" height="40">

ที ไลฟ์ ประกันชีวิต

โทร: [02-111-0055](tel:021110055)

 Line: [@tlife](https://line.me/R/ti/p/@tlife)  
 วันจันทร์ - ศุกร์ เวลา 8.30 - 17.00 น. (ยกเว้นวันหยุดราชการและวันหยุดประจำปี)

<img class="no-lazyload" src="/th/wp-content/uploads/2024/09/mtl_logo_tax_saving_page.webp" width="40" height="40">

เมืองไทยประกันชีวิต

โทร: [1766](tel:1766)

 Line: [@muangthailife](https://line.me/R/ti/p/@muangthailife)  
 ตลอด 24 ชั่วโมง

<img class="no-lazyload" src="/th/wp-content/uploads/2024/09/pru_logo_tax_saving_page.webp" width="40" height="40">

พรูเด็นเชียล ประกันชีวิต

โทร: [1621](tel:1621)

 E-mail: [[email protected]](/cdn-cgi/l/email-protection#b2daddc6dedbdcd7f2c2c0c7d6d7dcc6dbd3de9cd1dd9cc6da)   
 Line: [@prudentialthailand](https://line.me/R/ti/p/@prudentialthailand)  
 วันจันทร์ - ศุกร์ เวลา 8.30 - 19.00 น. วันเสาร์ เวลา 8.30 - 16.00 น. (ยกเว้นวันหยุดราชการและวันหยุดประจำปี)
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1938-4464" alt="" src="/th/wp-content/uploads/2024/09/rbl\_logo\_tax\_saving\_page.webp" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1954-4464" alt="" src="/th/wp-content/uploads/2024/09/Combined\_Shape\_Section\_3\_tax\_saving.webp" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1943-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

สายฟรีแลนซ์วางแผนง่าย

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-1946-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

จ่ายเบี้ยครั้งเดียวจบ ไม่มีภาระผูกพัน

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image
4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

มือใหม่เริ่มลดหย่อนยิ้มได้ ด้วยเบี้ยเริ่มต้นเบาๆ

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3570-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

ทยอยจ่ายได้แบบรายเดือน ไม่กระเทือนตอนสิ้นปี

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3573-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

ผลตอบแทนเฉลี่ยต่อปี (IRR) สูง 1.88%

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3803-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3591-4464" alt="" src="/th/wp-content/uploads/2024/09/smart-saving10-4-table\_saving\_page.webp" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3594-4464" alt="" src="/th/wp-content/uploads/2024/09/zoom\_in\_icon\_saving\_page.svg" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3783-4464" alt="" src="/th/wp-content/uploads/2024/09/PoseG\_hand\_coin\_right\_saving\_page.webp" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3784-4464" alt="" src="/th/wp-content/uploads/2024/09/Coin\_blur\_top\_saving\_page.webp" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3785-4464" alt="" src="/th/wp-content/uploads/2024/09/Coin\_blur\_top\_saving\_page\_.webp" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3786-4464" alt="" src="/th/wp-content/uploads/2024/09/Coin\_blur\_left\_saving\_page.webp" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-4595-4464" alt="" src="/th/wp-content/uploads/2024/07/fire\_logo\_for\_cancer\_section\_3.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3819-4464" alt="" src="/th/wp-content/uploads/2024/09/tcap\_logo\_tax\_saving\_page\_\_.webp" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3821-4464" alt="" src="/th/wp-content/uploads/2024/09/Combined\_Shape\_Section\_3\_tax\_saving.webp" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3825-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

สายลงทุนกดไลค์ เอาเงินคืนระหว่างสัญญาไปลงทุนต่อได้

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3828-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

ผลตอบแทนเฉลี่ยต่อปี (IRR) สูงปรี๊ด 2.40%

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3831-4464" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>

รับเงินคืนระหว่างสัญญาสูง 100%\*

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-4814-5972" alt="" src="/th/wp-content/uploads/2024/07/check\_small\_list\_cancer\_section\_3.png" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3852-4464" alt="" src="/th/wp-content/uploads/2024/10/smart-saving10-5-table\_saving\_page.webp" class="ct-image"/\>

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-3855-4464" alt="" src="/th/wp-content/uploads/2024/09/zoom\_in\_icon\_saving\_page.svg" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-4044-4464" alt="" src="/th/wp-content/uploads/2024/09/PoseG\_hand\_coin\_right\_saving\_page.webp" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-4045-4464" alt="" src="/th/wp-content/uploads/2024/09/Coin\_blur\_top\_saving\_page.webp" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-4046-4464" alt="" src="/th/wp-content/uploads/2024/09/Coin\_blur\_top\_saving\_page\_.webp" class="ct-image"/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-4047-4464" alt="" src="/th/wp-content/uploads/2024/09/Coin\_blur\_left\_saving\_page.webp" class="ct-image"/\>
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-4569-4464" alt="" src="/th/wp-content/uploads/2024/09/check-circle-solid\_copy\_success\_popup\_cancer\_page.webp" class="ct-image"/\>

คัดลอกแล้ว

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-2067-4464" alt="" src="/th/wp-content/uploads/2024/09/rbl\_logo\_tax\_saving\_page.webp" class="ct-image "/\>![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)\<img id="image-2074-4464" alt="" src="/th/wp-content/uploads/2024/09/close\_popup\_seemore\_image\_saving\_page.svg" class="ct-image" onclick="popUpInModal(&apos;&apos;, &apos;hide&apos;);"/\>
...
}());  document.addEventListener('DOMContentLoaded', function() { // หน่วงเวลาโหลด jQuery (10 วินาที) setTimeout(function() { var script = document.createElement('script'); script.src = 'https://www.heygoody.com/th/wp-includes/js/jquery/jquery.min.js'; document.body.appendChild(script); }, 10000); // หน่วงเวลาโหลด New Relic (10 วินาที) setTimeout(function() { var script = document.createElement('script'); script.src = 'https://js-agent.newrelic.com/nr-spa-1.281.0.min.js'; document.body.appendChild(script); }, 10000); }); window.addEventListener('DOMContentLoaded', function() {var div1 = document.getElementById('div\_block-747-4464');
var div2 = document.getElementById('div\_block-1738-4464');
window.onload = function() { div1.addEventListener('scroll', function() { div2.scrollLeft = div1.scrollLeft; }); div2.addEventListener('scroll', function() { div1.scrollLeft = div2.scrollLeft; });
}
window.onscroll = function() { myFunction(); if (window.scrollY \<= 750) { $("#div\_block-2153-2305").fadeOut(); $("#onetrust-consent-sdk").removeClass("show"); } else { $("#div\_block-2153-2305").fadeIn(); $("#onetrust-consent-sdk").addClass("show"); }
};
var header = document.getElementById("code\_block-587-11");
var targetElement = document.getElementById("text\_block-758-4464");
var targetElement2 = document.getElementById("div\_block-1199-4464"); function myFunction() { if (!header || !targetElement) { return; } var headerRect = header.getBoundingClientRect(); var targetRect = targetElement.getBoundingClientRect(); var targetRect2 = targetElement2.getBoundingClientRect(); if (headerRect.bottom \>= targetRect.top) { if ($(window).width() \<= 768) { $("#div\_block-1732-4464").css({ "top": "52px" }); div2.scrollLeft = div1.scrollLeft; div1.scrollLeft = div2.scrollLeft; } } if (targetRect2.top \> 210) { if ($(window).width() \<= 768) { $("#div\_block-1732-4464").css({ "top": "-100%" }); } }
} function copyTextToClipboard(text) { const textArea = document.createElement("textarea"); textArea.value = text; textArea.style.position = "fixed"; textArea.style.left = "-9999px"; document.body.appendChild(textArea); textArea.focus(); textArea.select(); try { document.execCommand('copy'); var copysuccess = document.getElementById("div\_block-4568-4464"); console.log('Text successfully copied'); copysuccess.style.display = "flex"; setTimeout(function() { copysuccess.style.display = "none"; }, 1200); } catch (err) { console.error('Unable to copy text', err); } document.body.removeChild(textArea);
}
...
});body { font-family: 'notosansthai'!important; background-color: #FCFAF7 !important; text-size-adjust: none; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; -moz-text-size-adjust: none;
}
@media (max-width: 768px) { body { overflow: auto !important; }
}
.ct-section { overflow-x: unset !important;
} #div\_block-747-4464,#div\_block-1738-4464,#div\_block-2092-4464 { overflow-x: scroll;
} #div\_block-747-4464::-webkit-scrollbar,#div\_block-1738-4464::-webkit-scrollbar,#div\_block-2053-4464::-webkit-scrollbar,#div\_block-2092-4464::-webkit-scrollbar,#div\_block-4215-4464::-webkit-scrollbar,#div\_block-4219-4464::-webkit-scrollbar,#div\_block-4374-4464::-webkit-scrollbar,#div\_block-4372-4464::-webkit-scrollbar,#div\_block-4376-4464::-webkit-scrollbar { display: none;
} #div\_block-1732-4464 { transition: all .6s ease-in-out;
} .sc-hgAwards,.fn-master-footer { z-index: 3; z-index: 3; position: relative;
}ul li::marker { font-size: 18px;
}
@media screen and (max-width: 767px) { /\* Mobile Detected \*/ .accordion-button.level-2 { padding: 16px 0px !important; } .n-text-insurance,.text-detail-condition { font-size: 14px !important; } .text-detail-condition { line-height: 26px !important; }
}
.text-detail-condition { color: var(--text-body-on-dark, #F9F9F4); font-family: Sarabun; font-size: 16px; font-style: normal; font-weight: 400; line-height: 26px;
} a.tel-bt:hover { color: #F9F9F4;
} .n-text-insurance { color: var(--text-body-on-dark, #F9F9F4); font-family: "Noto Sans Thai"; font-size: 18px; font-style: normal; margin: 0; line-height: normal;
} .text-incondition { color: var(--text-body-on-dark, #F9F9F4); font-family: Sarabun; font-size: 16px; font-style: normal; font-weight: 400; line-height: 26px; /\* 162.5% \*/
...
.accordion-item h4 { font-size: 18px; font-family: NotoSansThai; line-height: normal; margin: 0; font-weight: bold;
