...
[![](https://www.heygoody.com/th/wp-content/uploads/2023/03/icon-other-grey-search-dark.svg)](/th/search/)[![](https://www.heygoody.com/th/wp-content/uploads/2023/03/icon-other-grey-member-dark-2.svg)](/member/)[เข้าสู่ระบบ](/member/)
...
[![](https://www.heygoody.com/th/wp-content/uploads/2023/03/usericon.svg)](/member/)

 jQuery(document).ready(function() { var selector = "#\_header-26-11", scrollval = parseInt("52"); if (!scrollval || scrollval \< 1) { jQuery("body").css("margin-top", jQuery(selector).outerHeight()); jQuery(selector).addClass("oxy-sticky-header-active"); } else { var scrollTopOld = 0; jQuery(window).scroll(function() { if (!jQuery('body').hasClass('oxy-nav-menu-prevent-overflow')) { if (jQuery(this).scrollTop() \> scrollval ) { if ( !jQuery(selector).hasClass("oxy-sticky-header-active")) { if (jQuery(selector).css('position')!='absolute') { jQuery("body").css("margin-top", jQuery(selector).outerHeight()); } jQuery(selector) .addClass("oxy-sticky-header-active") } } else { jQuery(selector) .removeClass("oxy-sticky-header-fade-in") .removeClass("oxy-sticky-header-active"); if (jQuery(selector).css('position')!='absolute') { jQuery("body").css("margin-top", ""); } } scrollTopOld = jQuery(this).scrollTop(); } }) } });

คำถามที่พบบ่อย

เลือกหมวดหมู่ที่ต้องการ

 ซื้อประกัน heygoody ![](/th/wp-content/uploads/2023/10/icon-24-grey-down-small.svg)
...
* [ชั้น 1](#Car_Insure_Class_1)
* [ชั้น 2+, 2](#Car_Insure_Class_2)
* [ชั้น 3+, 3](#Car_Insure_Class_3)

// Function to handle anchor link clicks with scroll offset
function handleAnchorLinkClick(event) { // Prevent the default behavior (changing the URL) event.preventDefault(); // Get the target section's ID from the link's href attribute const targetID = event.target.getAttribute('href'); // Get the target section by ID const targetSection = document.querySelector(targetID); // Calculate the offset position, including the scroll offset of -10 pixels const offsetPosition = targetSection.getBoundingClientRect().top + window.scrollY - 200; // Scroll to the target section smoothly with the offset window.scrollTo({ top: offsetPosition, behavior: 'smooth' });
} // Add click event listener to all anchor links with href starting with '#'
const anchorLinks = document.querySelectorAll('a[href^="#"]');
anchorLinks.forEach(link =\> { link.addEventListener('click', handleAnchorLinkClick);
}); // Function to add the "active" class to the navigation links
function setActiveNavLink() { // ... (the rest of the setActiveNavLink() function remains the same)
} // Call the function when the page has loaded and on scroll
window.onload = function() { setActiveNavLink(); // Add event listener to update active link on scroll window.addEventListener('scroll', setActiveNavLink);
};
...
เมื่อเกิดอุบัติเหตุสามารถเช็คเบอร์และโทรหาบริษัทประกันภัยได้ที่หน้า [“การเคลมประกัน”](https://heygoody.com/th/how-to-claim/) หรือพิมพ์ “แจ้งเคลม” ทางไลน์ [@heygoody](https://line.me/R/ti/p/@heygoody) และเลือก “ขั้นตอนและรายละเอียดการเคลม” หรือ “ติดต่อบริษัทประกัน” ได้ทันที
...
ลูกค้าสามารถเข้าไปค้นหาอู่หรือศูนย์บริการได้ที่ [GoGo Garage](https://www.gogo-garage.com/)
...
### ซื้อประกันรถยนต์ไฟฟ้าเลือกค่าเสียหายส่วนแรกได้หรือไม่? ###

----------

ประกันรถยนต์ไฟฟ้าในปัจจุบัน จะยังไม่มีแผนค่าเสียหายส่วนแรก

### ประกันรถยนต์ไฟฟ้าคุ้มครองรถประเภทไหนบ้าง? ###

----------

คุ้มครองรถยนต์ไฟฟ้าประเภท BEV (Battery Electric Vehicle) ที่มีมอเตอร์ไฟฟ้าขับเคลื่อนเพียงอย่างเดียว ไม่มีเครื่องยนต์ และใช้พลังงานไฟฟ้าจากแบตเตอรี่เท่านั้น

### ใช้รถยนต์ไฟฟ้า มาแล้ว 3 ปี จะรับประกันแบตเตอรี่ 100% หรือไม่? ###

----------

ไม่คุ้มครอง 100% สำหรับแบตเตอรี่ที่มีอายุการใช้งานเกินกว่า 3 ปี (แต่ไม่เกิน 4 ปี) จะได้รับความคุ้มครอง 70%

### หากเกิดความเสียหาย หรืออุบัติเหตุขณะชาร์จ จะได้รับความคุ้มครองหรือไม่? ###

----------

หากกรมธรรม์รถยนต์ไฟฟ้ามีความคุ้มครองดังกล่าว จะได้รับความคุ้มครอง เช่น แผนประกันรถยนต์ไฟฟ้าจากแอกซ่า

### ทำไมประกันรถยนต์ไฟฟ้าถึงมีค่าเบี้ยแพงกว่าประกันรถยนต์น้ำมันเชื้อเพลิง? ###

----------

เนื่องจากรถยนต์ไฟฟ้ามีการใช้เทคโนโลยีที่ซับซ้อนในการผลิต และมีชิ้นส่วนหลักคือแบตเตอรี่ซึ่งเป็นอะไหล่ที่มีราคาสูง ทำให้ต้นทุนค่าซ่อมบำรุง และอะไหล่มีราคาสูงตาม ดังนั้น บริษัทประกันจึงต้องกำหนดค่าเบี้ยไว้สูงกว่ารถยนต์น้ำมันทั่วไป เพื่อให้วงเงินสามารถคุ้มครองความเสียหายที่อาจเกิดขึ้นได้

### ซ่อมรถยนต์ไฟฟ้า EV ได้ที่ไหนบ้าง? ###

----------

สามารถเข้าไปค้นหาอู่หรือศูนย์บริการได้ที่[GoGo Garage](https://www.gogo-garage.com/)
...
![](/th/wp-content/uploads/2024/02/msig_logo_claim_travel.png)

เอ็ม เอส ไอ จี ประกันภัย  
 โทร: [+662 039 5704](tel:+6620395704)

![](/th/wp-content/uploads/2024/02/sompo_icon_how_to_claim_page_re.png)

ซมโปะ ประกันภัย  
 โทร: [+662 205 7775](tel:+6622057775)

![](/th/wp-content/uploads/2024/02/kpi_icon_how_to_claim_page_re.png)
...
<img src="/heygoody/media/source/license/image-footer-heygoody-broker-license-online.jpg" alt="เลขที่ใบอนุญาตเสนอขายประกันภัยผ่านช่องทางอิเล็กทรอนิกส์" class="img-fluid" oncontextmenu="return false;" width="752" height="532">

 function modalLicenseOnline() { $("#BrokerLicenseOnline").modal("show"); }

เลขที่ใบอนุญาตประกันวินาศภัย

<img src="/heygoody/media/source/license/image-footer-heygoody-broker-license.jpg" alt="เลขที่ใบอนุญาตประกันวินาศภัย" class="img-fluid" oncontextmenu="return false;" width="752" height="532">
...
<img src="/content/images/home-new/awards/trophy.png" width="114">

<img src="/getattachment/b614ccd8-ce25-4721-be2f-75dbc480f8f6/itc.png" alt="Insure Tech Connect Asia" height="48" class="swp-img">

Insure Tech Connect Asia

Brokerage Breakthrough · Data Analytics Master Awards - 2024

<img src="/getattachment/70102a11-9c7e-49f1-97c2-4c95bb54a1df/tdb.png" alt="Global Retail Banking Innovation" height="48" class="swp-img">

Global Retail Banking Innovation

Best Customer Centric Business Model - 2024

<img src="/getattachment/f245e48c-0afd-40d6-a0bd-6872cdf6a641/nyf.webp" alt="New York Festivals Awards 2024" height="48" class="swp-img">

New York Festivals Awards 2024

Best Customer Centric Business Model - 2024

<img src="/getattachment/e936879e-55c8-4a59-91f5-580a2888867b/thework.png" alt="The Work 2024" height="48" class="swp-img">

The Work 2024

Film/TV Craft · Film/Web Film · Culture · Work for Good · Branded Content+Entertainment - 2024

<img src="/getattachment/b8250f6e-ef4f-4af4-af66-888a1b4a2d30/influencer.png" alt="Thailand Influencer Awards 2024 by Tellscore" height="48" class="swp-img">

Thailand Influencer Awards 2024 by Tellscore

Best Financial & Investment Influencer Campaign - 2024

<img src="/getattachment/2fd0fc28-55d6-4142-b245-13cd584c7b05/ad-people-v1.png" alt="AdPeople Awards &amp; Symposium 2024" height="48" class="swp-img">
...
<img src="/getattachment/45e2ce0f-e6cc-4e97-874e-53f55cb9120f/mat.png" alt="Marketing Award of Thailand 2024" height="48" class="swp-img">

Marketing Award of Thailand 2024

Silver -Brand Experience & Communication

<img src="/heygoody/media/footersection/color-white.svg?ext=.svg" alt="heygoody" width="147" height="46">
...
<img class="oic" src="/heygoody/media/footersection/image-logo-oic.svg?ext=.svg" alt="oic" width="83" height="36"> <img class="dbd" src="/heygoody/media/footersection/image-logo-dbd.svg?ext=.svg" alt="dbd" width="83" height="36">
...
}());  document.addEventListener('DOMContentLoaded', function() { // หน่วงเวลาโหลด jQuery (10 วินาที) setTimeout(function() { var script = document.createElement('script'); script.src = 'https://www.heygoody.com/th/wp-includes/js/jquery/jquery.min.js'; document.body.appendChild(script); }, 10000); // หน่วงเวลาโหลด New Relic (10 วินาที) setTimeout(function() { var script = document.createElement('script'); script.src = 'https://js-agent.newrelic.com/nr-spa-1.281.0.min.js'; document.body.appendChild(script); }, 10000); }); // Function to add the "active" class to the navigation links
function setActiveNavLink() { // Get all the navigation links within the specific div with ID "div\_block-34-1922" const navLinks = document.querySelectorAll('#navbar-car-insurance .nav-link'); // Get all the sections with class "ct-code-block" within the same div const sections = document.querySelectorAll('#div\_block-34-1922 .ct-code-block'); // Variable to keep track of the active section ID let activeSectionID = null; // Loop through each section sections.forEach(section =\> { // Check if the section is in the viewport if (section.getBoundingClientRect().top \<= window.innerHeight / 2) { // Get the ID of the active section activeSectionID = section.id; } }); // Loop through each navigation link navLinks.forEach(link =\> { // Get the target section's ID from the link's href attribute const targetID = link.getAttribute('href'); // Remove the "active" class from all navigation links link.classList.remove('active'); // Add the "active" class to the link corresponding to the active section if (targetID === `#${activeSectionID}`) { link.classList.add('active'); } });
} // Call the function when the page has loaded and on scroll
window.onload = function() { //setActiveNavLink(); // Add event listener to update active link on scroll //window.addEventListener('scroll', setActiveNavLink);
}; function getParameterByName(name, url = window.location.href) { name = name.replace(/[\\[\\]]/g, '\\\\$&'); var regex = new RegExp('[?&]' + name + '(=([^&#]\*)|&|#|$)'), results = regex.exec(url); if (!results) return null; if (!results[2]) return ''; return decodeURIComponent(results[2].replace(/\\+/g, ' ')); } // Get the 'section' parameter value from the URL var sectionParam = getParameterByName('section'); // Remove the 'selected\_' class from all \<a\> elements within \<li\> elements var aElements = document.querySelectorAll('.dropdown-menu li a'); aElements.forEach(function (a) { a.classList.remove('selected\_'); }); // Add the 'selected\_' class to the \<a\> element within the \<li\> element with the corresponding class name if (sectionParam) { //var defaultText = defaultLi.textContent; var splitparam = sectionParam.match(/\\d+/g); var selectedLi = document.querySelector('.' + sectionParam + ' a'); var Text = selectedLi.textContent; if (selectedLi) { selectedLi.classList.add('selected\_'); console.log(splitparam); displayCate(splitparam); document.querySelector('.Text\_Dropdown').innerHTML = Text + ' ' + '\<img id="arrowIcon" class="img\_arrow" src="/th/wp-content/uploads/2023/10/icon-24-grey-down-small.svg" /\>'; } } else { var defaultLi = document.querySelector('.section\_1 a'); if (defaultLi) { defaultLi.classList.add('selected\_'); var defaultText = defaultLi.textContent; } } function displayCate(category) { // Hide all divs with class starting with 'display\_' jQuery('[class^="ct-div-block display\_"]').hide(); // Show the specific div corresponding to the selected category jQuery('.ct-div-block.display\_' + category).show(); if(category == 2) { jQuery('.ct-div-block.display\_' + category).css('display','flex'); setActiveNavLink(); window.addEventListener('scroll', setActiveNavLink); }
}ul .nav-item::marker { content: '';
}
#inner\_content-13-11 { position: relative; background-image: url(/th/wp-content/uploads/2023/10/illustrate-faqs-header-desktop@2x\_faq.png); background-repeat: no-repeat; background-size: 1440px 344px; top: -68px; background-position: top;
}
#div\_block-25-1922 { background-image: url(/th/wp-content/uploads/2023/10/illustrate-mainins-element-heygoody-right@2x\_faq.png), url(https://dev.heygoody.com/th/wp-content/uploads/2023/07/illustrate-faqs-element-2-heygoody-left@2x\_faq.png); background-repeat: no-repeat; background-size: 240px 240px, 244px 72px; background-position: right bottom, left bottom; } @media screen and (max-width: 767px) { #inner\_content-13-11 { /\* Mobile Detected \*/ background-image: url(/th/wp-content/uploads/2023/10/illustrate-faqs-header-mobile@2x\_faq.png) !important; background-repeat: no-repeat; background-size: 100% 258px !important; top: 0px; } #div\_block-25-1922 { background-image: url(/th/wp-content/uploads/2023/10/illustrate-mainins-element-heygoody-right@2x\_faq.png), url(https://dev.heygoody.com/th/wp-content/uploads/2023/07/illustrate-faqs-element-2-heygoody-left@2x\_faq.png); background-repeat: no-repeat; background-size: 120px 120px, 122px 36px; background-position: right bottom, left bottom; } #div\_block-51-1922 { top: 20px !important; }
}
body { font-family: 'notosansthai'!important; background-color: #1d1d1d !important;
} @media (min-width: 1400px) { .container\_custom\_ { max-width: 1200px !important; }
} #section-129-1873 \> .ct-section-inner-wrap { margin: 0;
}
#div\_block-51-1922 { overflow: hidden; width: 100%; text-align: left; z-index: 999; top: 52px; -webkit-backdrop-filter: blur(20px); backdrop-filter: blur(20px); position: sticky; padding-top: 40px;
}jQuery(document).ready(function() { // When a dropdown item is clicked jQuery(".dropdown-item").on("click", function() { // Remove the "selected\_" class from all dropdown item jQuery(".dropdown-item").removeClass("selected\_"); // Get the text of the clicked item var selectedItem = jQuery(this).text(); //var imgtotext = ('src','/th/wp-content/uploads/2023/07/icon-24-grey-down-small.svg'); // Update the button text with the selected item and image tag jQuery("#dropdownButton").html(selectedItem + ' \<img class="img\_arrow" src="/th/wp-content/uploads/2023/10/icon-24-grey-down-small.svg"\>'); // Add the "selected\_" class to the clicked dropdown-item jQuery(this).addClass("selected\_"); });
}); .btn.btn-secondary.dropdown-toggle { background-color: #fff; text-align:left; border-style: none; color:#1d1d1d; padding: 12px 40px 12px 16px; font-family: NotoSansThai; font-size: 16px; font-weight: normal;
}
.dropdown-item.active, .dropdown-item:active,.dropdown-item:focus, .dropdown-item:hover { color: #1d1d1d; background-color: unset;
}
.dropdown-item { padding: 10px 16px;
}
.dropdown-menu.show { cursor: pointer;
}
ul.dropdown-menu { padding: 0;
}
.dropdown-toggle::after { content: unset !important; /\* Remove the default content \*/ }
.img\_arrow { transition: 0.2s; position: absolute; right: 21px;
}
.dropdown-toggle.show .img\_arrow { -webkit-transform:rotate(180deg); -moz-transform: rotate(180deg); -ms-transform: rotate(180deg); -o-transform: rotate(180deg); transform: rotate(180deg);
}
.dropdown-item.selected\_ { background-image: url(/th/wp-content/uploads/2023/10/icon-24-green-right-active.svg); background-repeat: no-repeat; background-position: right 21px center;
}.nav-pills { gap: 8px; font-family: NotoSansThai; font-size: 16px; font-weight: bold; font-stretch: normal; font-style: normal; line-height: normal; letter-spacing: normal;
}
.nav-pills .nav-link.active, .nav-pills .show\>.nav-link { color: #000000; background-color: #b6e4d4;
}
.nav-pills .nav-link { padding: 6px 12px; background-color: #2e2e2e; color: #ffffff; border-radius: 24px;
}/\*
ul li::marker { list-style: none; content: '' !important; font-size: 14px;
}
\*/
...
.accordion-item h3 { font-size: 16px; margin: 0; font-weight: bold;
} .accordion-button::after { background-image: url(/th/wp-content/uploads/2023/10/icon-24-white-up-small.svg); width: 24px; height: 24px; position: relative; background-position: right top;
}
.accordion-button:not(.collapsed)::after { background-image: url(/th/wp-content/uploads/2023/10/icon-24-white-up-small.svg); width: 24px; height: 24px; background-position: left top; position: relative;
}
...
} .accordion-button { font-family: NotoSansThai; font-size: 16px; font-weight: bold; font-stretch: normal; font-style: normal; line-height: normal; letter-spacing: normal; padding: 16px 0px; color: var(--bg-2-beige-100);
...
}.accordion-button.level-2::after { background-image: url(https://www.heygoody.com/th/wp-content/uploads/2023/10/icon-24-white-add@2x\_travel.png); width: 24px; height: 24px; position: relative; --bs-accordion-transition: unset !important; --bs-accordion-btn-icon-transform: unset !important; --bs-accordion-btn-icon-transition: unset !important; transition: unset !important;
}
.accordion-button.level-2:not(.collapsed)::after { background-image: url(https://www.heygoody.com/th/wp-content/uploads/2023/10/icon-24-white-add@2x\_travel.png); width: 24px; height: 24px; position: relative;
} /\* Set the icon for the expanded state \*/
.accordion-button.level-2[aria-expanded="true"]::after { background-image: url(https://www.heygoody.com/th/wp-content/uploads/2023/10/icon-24-white-minus@2x\_travel.png);
}
.accordion-button.level-2 { --bs-accordion-transition: unset !important; --bs-accordion-btn-icon-transform: unset !important; --bs-accordion-btn-icon-transition: unset !important; transition: unset !important;
}